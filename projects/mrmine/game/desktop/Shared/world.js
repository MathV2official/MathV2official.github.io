...
earth.workerHireCosts = [50 n, 500 n, 2000 n, 10000 n, 25000 n, 75000 n, 150000 n, 500000 n, 3000000 n, 10000000 n, 999999999999 n];
earth.workerLevelCosts = [0 n, 10000000 n, 50000000 n, 200000000 n, 1000000000 n, 6000000000 n, 40000000000 n, 350000000000 n, 1000000000000 n, 10000000000000 n, 100000000000000 n];
worlds.push(earth);
...
moon.workerLevel = 0;
moon.workersHired = 1;
moon.workerHireCosts = [0 n, 10000000000000 n, 25000000000000 n, 100000000000000 n, 400000000000000 n, 1800000000000000 n, 8000000000000000 n, 30000000000000000 n, 110000000000000000 n, 300000000000000000 n, 1000000000000000000 n];
moon.workerLevelCosts = [0 n, 2000000000000000000 n, 8000000000000000000 n, 20000000000000000000 n, 50000000000000000000 n, 80000000000000000000 n, 100000000000000000000 n, 140000000000000000000 n, 200000000000000000000 n, 300000000000000000000 n, 500000000000000000000 n];
worlds.push(moon);
...
titan.workerHireCosts = [0 n, 100000000000000000000 n, 300000000000000000000 n, 1000000000000000000000 n, 5000000000000000000000 n, 25000000000000000000000 n, 100000000000000000000000 n, 300000000000000000000000 n, 900000000000000000000000 n, 2700000000000000000000000 n, 7500000000000000000000000 n];
titan.workerLevelCosts = [0 n, 20000000000000000000000000 n, 40000000000000000000000000 n, 80000000000000000000000000 n, 160000000000000000000000000 n, 320000000000000000000000000 n, 640000000000000000000000000 n, 1280000000000000000000000000 n, 2560000000000000000000000000 n, 5120000000000000000000000000 n, 10240000000000000000000000000 n];
worlds.push(titan);

...
function runSplitTestSetup() {
    ...
    switch (splitTestValue1) {
        ...
        case 3:
            ...
            getEarth().workerHireCosts[0] = 20 n;
            getEarth().workerHireCosts[1] = 250 n;
            break;
        case 4:
            //change starting hire cost
            getEarth().workerHireCosts[0] = 30 n;
            getEarth().workerHireCosts[1] = 250 n;
            break;
        case 5:
            //change level difficulty for early levels
            depthDifficultyTable[0] = 120 n;
            depthDifficultyTable[1] = 120 n;
            depthDifficultyTable[2] = 120 n;
            depthDifficultyTable[3] = 130 n;
            depthDifficultyTable[4] = 155 n;
            depthDifficultyTable[5] = 190 n;
            depthDifficultyTable[6] = 220 n;
            depthDifficultyTable[7] = 283 n;
            depthDifficultyTable[8] = 320 n;
            depthDifficultyTable[9] = 386 n;
            depthDifficultyTable[10] = 450 n;
            depthDifficultyTable[11] = 503 n;
            depthDifficultyTable[12] = 605 n;
            depthDifficultyTable[13] = 755 n;
            depthDifficultyTable[14] = 1000 n;
            depthDifficultyTable[15] = 1350 n;
            depthDifficultyTable[16] = 1850 n;
            depthDifficultyTable[17] = 2000 n;
            depthDifficultyTable[18] = 3000 n;
            depthDifficultyTable[19] = 4000 n;
            break;
        case 6:
            //change level difficulty for early levels
            depthDifficultyTable[0] = 140 n;
            depthDifficultyTable[1] = 140 n;
            depthDifficultyTable[2] = 140 n;
            depthDifficultyTable[3] = 140 n;
            depthDifficultyTable[4] = 140 n;
            depthDifficultyTable[5] = 140 n;
            depthDifficultyTable[6] = 200 n;
            depthDifficultyTable[7] = 250 n;
            depthDifficultyTable[8] = 300 n;
            depthDifficultyTable[9] = 400 n;
            depthDifficultyTable[10] = 500 n;
            break;
        case 7:
            //no hint arrows
        ...
        case 11:
            drillBlueprints[12].ingredients[1] = {
...
function initializeTests() {
    ...
    */
    ...
    var headerTextBolded = statsig.getExperiment("bolded_header_text");
    var headerTextBoldedResult = headerTextBolded.get("Value", 0);
    console.log(headerTextBoldedResult);
    isHeaderTextBolded = headerTextBoldedResult == 1;

    var largerTooltipFont = statsig.getExperiment("larger_tooltip_font");
    var largerTooltipFontResult = largerTooltipFont.get("Value", 0);
    console.log(largerTooltipFontResult);
    if (largerTooltipFontResult == 1) {
        document.getElementById("TOOLTIP").style.fontSize = "16px";
    }

...
var excavationRewards = [{
        "id": 0,
        "name": _("Endless Miner Speed Potion"),
        "statType": MINER_SPEED_MULTIPLIER,
        "amount": 6,
        "image": speedPotion1,
        "rarity": .55,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [33, 25, 18, 12],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 54,
        "divineId": 87,
        "hasRewardScaling": false
    },
    {
        "id": 1,
        "name": _("Golden Shovel"),
        "statType": SELL_PRICE_MULTIPLIER,
        "amount": 6,
        "image": goldShovel,
        "rarity": .56,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [38, 19],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 55,
        "divineId": 88,
        "hasRewardScaling": false
    },
    {
        "id": 2,
        "name": _("Key of Luck"),
        "statType": CHEST_SPAWN_FREQUENCY,
        "amount": 5,
        "image": whiteKey,
        "rarity": .71,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [29, 13],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 56,
        "divineId": 89,
        "hasRewardScaling": false
    },
    {
        "id": 3,
        "name": _("Sword of War"),
        "statType": BATTLE_DAMAGE_MULTIPLIER,
        "amount": 5,
        "image": goldSword,
        "rarity": .5,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [22, 21],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 57,
        "divineId": 90,
        "hasRewardScaling": false
    ...
    {
        "id": 4,
        "name": _("Basic Treasure Chest"),
        "description": _("Basic Treasure Chest"),
        "image": basicChest,
        "rarity": .10,
        "isRelic": false,
        "grantFunction": openBasicChest,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": false
    },
    {
        "id": 5,
        "name": _("Golden Treasure Chest"),
        "description": _("Gold Treasure Chest"),
        "image": goldChest,
        "rarity": .92,
        "isRelic": false,
        "grantFunction": openGoldChest,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": false
    },
    {
        "id": 6,
        "name": _("2x Tickets"),
        "description": _("2 Tickets"),
        "image": ticketicon,
        "rarity": .67,
        "isRelic": false,
        "grantFunction": function() {
            tickets += 2;
        },
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [],
    ...
    {
        "id": 7,
        "name": _("Large bag of money"),
        "description": _("{0} minutes worth of money"),
        "image": goldBag,
        "rarity": .35,
        "isRelic": false,
        "grantFunction": function() {
            return {
                "function": grantMoneyMinutes,
                "baseReward": 15
            }
        },
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": true
    },
    {
        "id": 8,
        "name": _("Small bag of money"),
        "description": _("{0} minutes worth of money"),
        "image": brownBag,
        "rarity": .10,
        "isRelic": false,
    ...
    },
    {
        "id": 9,
        "name": _("Big Cheese"),
        "description": _("Double all current minerals in inventory (capped at 2x capacity)"),
        "image": cheese,
        "rarity": .94,
        "isRelic": false,
        "grantFunction": grantBigCheese,
        "isCandidateFunction": mineralsUnderTwoWeekCap,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": false
    },
    {
        ...
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": pikesUnder36hrs,
        "relatedIndexesForSacrifice": [38, 28],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 58,
        "divineId": 91,
        "hasRewardScaling": false
    },
    {
        "id": 11,
        "name": _("New Contract"),
        "description": _("Unlocks another scientist"),
        "image": scrollRelic,
        "rarity": .57,
        "isRelic": false,
        "grantFunction": unlockRandomScientist,
        "isCandidateFunction": function() {
            return !isActiveScientistsFull();
        },
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": false
    ...
    {
        "id": 12,
        "name": _("Endless Scientist Experience Potion"),
        "statType": SCIENTIST_EXPERIENCE_MULTIPLIER,
        "amount": 15,
        "image": speedPotion2,
        "rarity": .75,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [33, 25, 18, 0, 20],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 59,
        "divineId": 92,
        "hasRewardScaling": false
    },
    {
        "id": 13,
        "name": _("Key of Gold"),
        "statType": GOLD_CHEST_SPAWN_FREQUENCY_MULTIPLIER,
        "amount": 5,
        "image": goldKey,
        "rarity": .91,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [29, 2],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 60,
        "divineId": 93,
        "hasRewardScaling": false
    },
    {
        "id": 14,
        "name": _("Relic Bag"),
        "description": _("Increases max relic slots by 1"),
        "image": backpack,
        "rarity": .72,
        "isRelic": false,
        "grantFunction": expandRelicInventory,
        "isCandidateFunction": isRelicInventoryExpandable,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": false
    },
    ...
    {
        "id": 16,
        "name": _("Large Mineral Pile"),
        "description": _("{0} minutes worth of income as a random mineral"),
        "image": mineralPileLarge,
        "rarity": .12,
        "isRelic": false,
        "grantFunction": function() {
            return {
                "function": scientistsGrantMineralsForMinutes,
                "baseReward": 10
            }
        },
        "isCandidateFunction": alwaysTrue,
    ...
    {
        "id": 17,
        "name": _("Medium Mineral Pile"),
        "description": _("{0} minutes worth of income as a random mineral"),
        "image": mineralPileMedium,
        "rarity": .05,
        "isRelic": false,
        "grantFunction": function() {
            return {
    ...
    {
        "id": 18,
        "name": _("Endless Drill Speed Potion"),
        "statType": DRILL_SPEED_MULTIPLIER,
        "amount": 10,
        "image": speedPotion3,
        "rarity": .70,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [33, 25, 0, 12],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 61,
        "divineId": 94,
        "hasRewardScaling": false
    ...
    {
        "id": 19,
        "name": _("Sparkly Distraction"),
        "statType": BLUEPRINT_PRICE_MULTIPLIER,
        "amount": 6,
        "image": yellowGem,
        "rarity": .60,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [27, 1],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 62,
        "divineId": 95,
        "hasRewardScaling": false
    ...
    {
        "id": 20,
        "name": _("Book of Success"),
        "statType": INCREASED_EXCAVATION_SUCCESS_RATE_PERCENT,
        "amount": 10,
        "image": yellowBook,
        "rarity": .90,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [12, 36],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 63,
        "divineId": 96,
        "hasRewardScaling": false
    },
    {
        "id": 21,
        "name": _("Steel Shield"),
        "statType": BATTLE_HEALTH_MULTIPLIER,
        "amount": 5,
        "image": shield2,
        "rarity": .55,
        "isRelic": true,
    ...
    {
        "id": 22,
        "name": _("Light Golden Boots"),
        "statType": WEAPON_SPEED_MULTIPLIER,
        "amount": 5,
        "image": goldBoot,
        "rarity": .55,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [3, 21],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 65,
        "divineId": 98,
        "hasRewardScaling": false
    ...
    {
        "id": 23,
        "name": _("Golden Scythe"),
        "statType": SCIENTIST_RESURRECTION_PERCENT_CHANCE,
        "amount": 5,
        "image": scytheGold,
        "rarity": .80,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [36, 37],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 66,
        "divineId": 99,
        "hasRewardScaling": false
    ...
    {
        "id": 24,
        "name": _("Small Mineral Pile"),
        "description": _("{0} minutes worth of income as a random mineral"),
        "image": mineralPileSmall,
        "rarity": 0,
        "isRelic": false,
        "grantFunction": function() {
            return {
    ...
    {
        "id": 25,
        "name": _("Endless Gem Speed Potion"),
        "statType": GEM_SPEED_MULTIPLIER,
        "amount": 5,
        "image": speedPotion4,
        "rarity": .55,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [26, 31, 33, 0, 18, 12],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 67,
        "divineId": 100,
        "hasRewardScaling": false
    ...
    {
        "id": 26,
        "name": _("Book of Ingenuity"),
        "statType": BUILDING_MATERIAL_CHANCE_MULTIPLIER,
        "amount": 6,
        "image": blueBook,
        "rarity": .65,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [25, 31],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 68,
        "divineId": 101,
        "hasRewardScaling": false
    },
    {
        "id": 27,
        "name": _("Midas Touch"),
        "statType": PERCENT_CHANCE_OF_SELLING_FOR_DOUBLE,
        "amount": 5,
        "image": goldHand,
        "rarity": .85,
        "isRelic": true,
    ...
    {
        "id": 28,
        "name": _("Elemental Pike"),
        "statType": ISOTOPE_DISCOVERY_CHANCE_MULTIPLIER,
        "amount": 15,
        "image": basicPike,
        "rarity": .85,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [38, 10],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 70,
        "divineId": 103,
        "hasRewardScaling": false
    ...
    {
        "id": 29,
        "name": _("Nugget of Attraction"),
        "statType": CHEST_MONEY_MULTIPLIER,
        "amount": 10,
        "image": goldRock,
        "rarity": .70,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [2, 13],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 71,
        "divineId": 104,
        "hasRewardScaling": false
    },
    {
        "id": 30,
        "name": _("Book of Time"),
        "statType": TIMELAPSE_DURATION_MULTIPLIER,
        "amount": 10,
        "image": purpleBook,
        "rarity": .65,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [25, 18, 12],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 72,
        "divineId": 105,
        "hasRewardScaling": false
    },
    {
        "id": 31,
        "name": _("Wider Well"),
        "statType": OIL_GENERATION_MULTIPLIER,
        "amount": 5,
        "image": OIL_icon,
        "rarity": .50,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [25, 26],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 73,
        "divineId": 106,
        "hasRewardScaling": false
    ...
    {
        "id": 32,
        "name": _("Unlock a New Weapon"),
        "description": _("Unlocks a new battle weapon"),
        "image": swordUnlock,
        "rarity": .50,
        "isRelic": false,
        "grantFunction": unlockRandomWeapon,
        "isCandidateFunction": function() {
            return userReachedUnderground() && !alreadyUnlockedAllEquips();
        },
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": false
    },
    {
        "id": 33,
        "name": _("Pay Cut"),
        "statType": MINER_UPGRADE_AND_HIRE_COST_MULTIPLIER,
        "amount": 5,
        "image": ateCookie,
        "rarity": .45,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [0, 25, 18, 12],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 74,
        "divineId": 107,
        "hasRewardScaling": false
    },
    {
        "id": 34,
        "name": _("Oil"),
        "description": _("Some Oil"),
        "image": OIL_icon,
        "rarity": .40,
        "isRelic": false,
        "grantFunction": function() {
            worldResources[OIL_INDEX].numOwned += Math.ceil(oilRigStats[oilrigStructure.level][1] / 4);
        },
        "isCandidateFunction": function() {
            return userReachedUnderground() && !isOilRigFull()
        },
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": false
    ...
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [23, 37],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 76,
        "divineId": 109,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [23, 36],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 77,
        "divineId": 110,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": pikesUnder36hrs,
        "relatedIndexesForSacrifice": [10, 28, 1],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 78,
        "divineId": 111,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [49, 50, 51],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 79,
        "divineId": 112,
        "hasRewardScaling": false
    ...
    },
    {
        ...
        "isCandidateFunction": isTimelapseAvailable,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": true
    },
    {
        "id": 42,
        "name": _("Strawberry of Time"),
        "description": _("{0} minutes of timelapse"),
        "image": strawberryOfTime,
        "rarity": .3,
        "isRelic": false,
        "grantFunction": function() {
            return {
    ...
    {
        "id": 44,
        "name": _("Chocolate of Time"),
        "description": _("{0} minutes of timelapse"),
        "image": chocolateOfTime,
        "rarity": .45,
        "isRelic": false,
        "grantFunction": function() {
            return {
    ...
    {
        "id": 45,
        "name": _("Book of Secrets"),
        "statType": UNUSED_STAT,
        "description": _("Doesn't seem to do anything"),
        "image": blackBook,
        "rarity": .94,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [20, 26, 30],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 80,
        "divineId": 113,
        "hasRewardScaling": false
    },
    {
        ...
        "isCandidateFunction": isBelow600km,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
        "hasRewardScaling": false
    },
    {
        "id": 47,
        "name": _("Sack of Endurance"),
        "statType": BUFF_DURATION_MULTIPLIER,
        "amount": 7,
        "image": greenBag,
        "rarity": .50,
        "isRelic": true,
    ...
    {
        "id": 48,
        "name": _("Cargo Expansion"),
        "statType": CARGO_CAPACITY_MULTIPLIER,
        "amount": 15,
        "image": purpleBag,
        "rarity": .40,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [47, 52],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 82,
        "divineId": 115,
        "hasRewardScaling": false
    },
    {
        "id": 49,
        "name": _("Bullseye"),
        "statType": BATTLE_CRIT_CHANCE_PERCENT,
        "amount": 5,
        "image": bowRelic1,
        "rarity": .30,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [50, 51],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 83,
        "divineId": 116,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [49, 51],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 84,
        "divineId": 117,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": userReachedUnderground,
        "relatedIndexesForSacrifice": [49, 50],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 85,
        "divineId": 118,
        "hasRewardScaling": false
    ...
    {
        "id": 52,
        "name": _("Egg of Incubation"),
        "statType": OFFLINE_PROGRESS_DURATION_MULTIPLIER,
        "amount": 10,
        "image": eggRelic,
        "rarity": .75,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": userHasManager,
        "relatedIndexesForSacrifice": [48],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 86,
        "divineId": 119,
    ...
    },
    {
        ...
        "grantFunction": unlockRandomWeapon,
        "isCandidateFunction": function() {
            return userReachedUnderground() && !alreadyUnlockedAllEquips() && isOnBossLevel();
        },
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction
    },
    ...
    //Warped Relics Below
    {
        ...
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [74, 67, 61, 59],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 54,
        "divineId": 87,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [78, 62],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 55,
        "divineId": 88,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [71, 60],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 56,
        "divineId": 89,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [65, 66],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 57,
        "divineId": 90,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [78, 70],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 58,
        "divineId": 91,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [74, 67, 61, 54, 63],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 59,
        "divineId": 92,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [71, 56],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 60,
        "divineId": 93,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [74, 67, 54, 59],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 61,
        "divineId": 94,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [69, 55],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 62,
        "divineId": 95,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [59, 76],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 63,
        "divineId": 96,
        "hasRewardScaling": false
    ...
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [57, 66],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 65,
        "divineId": 98,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [76, 77],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 66,
        "divineId": 99,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [68, 73, 74, 54, 61, 59],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 67,
        "divineId": 100,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [67, 73],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 68,
        "divineId": 101,
        "hasRewardScaling": false
    ...
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [78, 58],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 70,
        "divineId": 103,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [56, 60],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 71,
        "divineId": 104,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [67, 61, 59],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 72,
        "divineId": 105,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [67, 68],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 73,
        "divineId": 106,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [54, 67, 61, 59],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 74,
        "divineId": 107,
        "hasRewardScaling": false
    ...
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [66, 77],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 76,
        "divineId": 109,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [66, 76],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 77,
        "divineId": 110,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [58, 70, 55],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 78,
        "divineId": 111,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [83, 84, 85],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 79,
        "divineId": 112,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [63, 68, 72],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 80,
        "divineId": 113,
        "hasRewardScaling": false
    ...
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [81, 86],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 82,
        "divineId": 115,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [84, 85],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 83,
        "divineId": 116,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [83, 85],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 84,
        "divineId": 117,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [83, 84],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 85,
        "divineId": 118,
        "hasRewardScaling": false
    ...
    //Divine Relics Below
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [107, 100, 94, 92],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 87,
        "divineId": 87,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [111, 95],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 88,
        "divineId": 88,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [104, 93],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 89,
        "divineId": 89,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [98, 99],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 90,
        "divineId": 90,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [111, 103],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 91,
        "divineId": 91,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [107, 100, 94, 87, 96],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 92,
        "divineId": 92,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [104, 89],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 93,
        "divineId": 93,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [107, 100, 87, 92],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 94,
        "divineId": 94,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [102, 88],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 95,
        "divineId": 95,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [92, 109],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 96,
        "divineId": 96,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [108],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 97,
        "divineId": 97,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [90, 99],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 98,
        "divineId": 98,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [109, 110],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 99,
        "divineId": 99,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [101, 106, 107, 87, 94, 92],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 100,
        "divineId": 100,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [100, 106],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 101,
        "divineId": 101,
        "hasRewardScaling": false
    ...
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [111, 91],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 103,
        "divineId": 103,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [89, 93],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 104,
        "divineId": 104,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [100, 94, 92],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 105,
        "divineId": 105,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [100, 101],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 106,
        "divineId": 106,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [87, 100, 94, 92],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 107,
        "divineId": 107,
        "hasRewardScaling": false
    ...
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [99, 110],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 109,
        "divineId": 109,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [99, 109],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 110,
        "divineId": 110,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [91, 103, 88],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 111,
        "divineId": 111,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [116, 117, 118],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 112,
        "divineId": 112,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [96, 101, 105],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 113,
        "divineId": 113,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [115],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 114,
        "divineId": 114,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [114, 119],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 115,
        "divineId": 115,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [117, 118],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 116,
        "divineId": 116,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [116, 118],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 117,
        "divineId": 117,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [116, 117],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 118,
        "divineId": 118,
        "hasRewardScaling": false
    ...
    {
        "id": 120,
        "name": _("Pile of Building Materials"),
        "description": _("2x Building Materials"),
        "image": buildingMaterialsIcon,
        "rarity": .18,
        "isRelic": false,
        "grantFunction": function() {
            worldResources[BUILDING_MATERIALS_INDEX].numOwned += 2;
            newNews(_("You gained {0} building materials from excavation", 2), true);
        },
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
    ...
    {
        "id": 121,
        "name": _("Stack of Building Materials"),
        "description": _("10x Building Materials"),
        "image": buildingMaterialsIcon,
        "rarity": .49,
        "isRelic": false,
        "grantFunction": function() {
            worldResources[BUILDING_MATERIALS_INDEX].numOwned += 10;
            newNews(_("You gained {0} building materials from excavation", 10), true);
        },
        "isCandidateFunction": isBelow600km,
        "relatedIndexesForSacrifice": [],
        "renderFunction": standardRelicRenderFunction,
    ...
    {
        "id": 122,
        "name": _("Super Miner Souls"),
        "description": _("{0} Super Miner Souls"),
        "image": superMinerSoulHD,
        "rarity": .45,
        "isRelic": false,
        "grantFunction": function() {
            return {
                "function": addSuperMinerSouls,
                "baseReward": 2
            }
        },
        "isCandidateFunction": alwaysTrue,
    ...
    {
        "id": 123,
        "name": _("Fuel Extractor"),
        "statType": DRONE_FUEL_REGEN_MULTIPLIER,
        "amount": 7.5,
        "image": fuelRegen,
        "rarity": .65,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [126, 129],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 124,
        "divineId": 125,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [127, 130],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 124,
        "divineId": 125,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [128, 131],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 125,
        "divineId": 125,
        "hasRewardScaling": false
...

    {
        "id": 126,
        "name": _("Fuel Tank"),
        "statType": DRONE_STARTING_FUEL_MULTIPLIER,
        "amount": 7.5,
        "image": startingFuel,
        "rarity": .65,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [123, 129],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 127,
        "divineId": 128,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [124, 130],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 127,
        "divineId": 128,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [125, 131],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 128,
        "divineId": 128,
        "hasRewardScaling": false
...

    {
        ...
        "statType": DRONE_MOVEMENT_SPEED_MULTIPLIER,
        "amount": 7.5,
        "image": droneSpeed,
        "rarity": .75,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
        "relatedIndexesForSacrifice": [126, 123],
        "renderFunction": standardRelicRenderFunction,
        "warpId": 130,
        "divineId": 131,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [127, 124],
        "renderFunction": warpedRelicRenderFunction,
        "warpId": 130,
        "divineId": 131,
        "hasRewardScaling": false
    },
    {
        ...
        "grantFunction": null,
        "isCandidateFunction": alwaysFalse,
        "relatedIndexesForSacrifice": [128, 125],
        "renderFunction": divineRelicRenderFunction,
        "warpId": 131,
        "divineId": 131,
        "hasRewardScaling": false
...

    {
        "id": 132,
        "name": _("Juicer"),
        "statType": SUPER_MINER_SPEED,
        "amount": 5,
        "image": superMinerSpeed,
        "rarity": .9,
        "isRelic": true,
        "grantFunction": null,
        "isCandidateFunction": alwaysTrue,
...
var excavations = [{
        "difficulty": _("Easy"),
        "names": [_("Sift Surface Dirt"), _("Metal Detect Surface"), _("Lidar Artifact Scan")],
        "numericDifficultyRange": [0, 0],
        "durationOptionsInMinutes": [30, 60, 90, 120],
        "rewardSkew": 12,
        "minimumValue": 0,
        "maximumValue": 0.40
    }, //gamma curve Math.pow(Math.random(), 12); with min minimumValue
    {
        "difficulty": _("Medium"),
        "names": [_("Explore Shallow Cave"), _("Sift Crater Top Soil"), _("Utilize Magnetometer At 40km")],
        "numericDifficultyRange": [5, 10],
        "durationOptionsInMinutes": [30, 60, 90, 120],
        "rewardSkew": 6,
        "minimumValue": .15,
        "maximumValue": 0.51
    }, //gamma curve Math.pow(Math.random(), 6); with min minimumValue
    {
        "difficulty": _("Hard"),
        "names": [_("Explore Lost Tomb"), _("Excavate Crater"), _("Dredge Groundwater")],
        "numericDifficultyRange": [25, 50],
        "durationOptionsInMinutes": [120, 150, 180, 210],
        "rewardSkew": 2,
        "minimumValue": .50,
        "maximumValue": 0.85
    }, //gamma curve Math.pow(Math.random(), 2); with min minimumValue
    {
        "difficulty": _("Nightmare"),
        "names": [_("Explore Deep Cavern"), _("Excavate Ancient Cave"), _("Excavate Deep Pit")],
        "numericDifficultyRange": [50, 99],
        "durationOptionsInMinutes": [180, 240, 300, 360],
        "rewardSkew": 1,
        "minimumValue": .80,
        "maximumValue": 1.00
    } //gamma curve Math.pow(Math.random(), 1); with min minimumValue
];
...
var scientists = [
    //Normal Scientists
    {
        ...
        "name": "Jank",
        "rarity": _("Common"),
        "deathChanceMultiple": 1,
        "image": arch2,
        "blinkImage": arch2_blink,
        "additionalRewardCandidates": 0,
        "isNormal": true
    },
    {
        "id": 1,
    ...
    },
    {
        ...
        "name": "Dallas",
        "rarity": _("Uncommon"),
        "deathChanceMultiple": 0.90,
        "image": arch10,
        "blinkImage": arch10_blink,
        "additionalRewardCandidates": 0,
        "isNormal": true
    },
    {
    ...
    },
    {
        ...
        "name": "Mr. Mustache",
        "rarity": _("Rare"),
        "deathChanceMultiple": 0.75,
        "image": arch5,
        "blinkImage": null,
        "additionalRewardCandidates": 1,
        "isNormal": true
    },
    {
        "id": 11,
    ...
    },
    {
        ...
        "name": "Dr. Archibald",
        "rarity": _("Legendary"),
        "deathChanceMultiple": 0.45,
        "image": arch1,
        "blinkImage": arch1_blink,
        "additionalRewardCandidates": 3,
        "isNormal": true
    },
    {
        "id": 13,
    ...
    //Warped Scientists
    {
        "id": 19,
        "warpedId": 19,
        "name": unicodeToStringCode(warpedJankName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.75,
        "image": arch2w,
        "blinkImage": arch2w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
    ...
    },
    {
        "id": 21,
        "warpedId": 21,
        "name": unicodeToStringCode(warpedMrsMargeName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.75,
        "image": arch3w,
        "blinkImage": arch3w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 22,
        "warpedId": 22,
        "name": unicodeToStringCode(warpedTaylorName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.75,
        "image": arch4w,
        "blinkImage": arch4w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 23,
        "warpedId": 23,
        "name": unicodeToStringCode(warpedZiggyName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.75,
        "image": arch8w,
        "blinkImage": arch8w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
    ...
    },
    {
        "id": 25,
        "warpedId": 25,
        "name": unicodeToStringCode(warpedTheAussieName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.75,
        "image": arch9w,
        "blinkImage": arch9w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 26,
        "warpedId": 26,
        "name": unicodeToStringCode(warpedDallasName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.675,
        "image": arch10w,
        "blinkImage": arch10w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 27,
        "warpedId": 27,
        "name": unicodeToStringCode(warpedErnieName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.675,
        "image": arch7w,
        "blinkImage": arch7w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 28,
        "warpedId": 28,
        "name": unicodeToStringCode(warpedDrGilbertName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.675,
        "image": arch11w,
        "blinkImage": arch11w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 29,
        "warpedId": 29,
        "name": unicodeToStringCode(warpedMrMustacheName),
        "rarity": _("Warped+"),
        "deathChanceMultiple": 0.40,
        "image": arch5w,
        "blinkImage": arch5w_blink,
        "additionalRewardCandidates": 2,
        "isNormal": false
    },
    {
        "id": 30,
        "warpedId": 30,
        "name": unicodeToStringCode(warpedMrMustachioName),
        "rarity": _("Warped+"),
        "deathChanceMultiple": 0.40,
        "image": arch6w,
        "blinkImage": arch6w_blink,
        "additionalRewardCandidates": 2,
        "isNormal": false
    },
    {
        "id": 31,
        "warpedId": 31,
        "name": unicodeToStringCode(warpedDrArchibaldName),
        "rarity": _("Warped++"),
        "deathChanceMultiple": 0.30,
        "image": arch1w,
        "blinkImage": arch1w_blink,
        "additionalRewardCandidates": 4,
        "isNormal": false
    },
    {
        "id": 32,
        "warpedId": 32,
        "name": unicodeToStringCode(warpedLtRamirezName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.75,
        "image": arch16w,
        "blinkImage": arch16w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 33,
        "warpedId": 33,
        "name": unicodeToStringCode(warpedLaylaName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.75,
        "image": arch15w,
        "blinkImage": arch15w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 34,
        "warpedId": 34,
        "name": unicodeToStringCode(warpedDrFranduzleName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.675,
        "image": arch12w,
        "blinkImage": arch12w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    },
    {
        "id": 35,
        "warpedId": 35,
        "name": unicodeToStringCode(warpedProfessorZanyName),
        "rarity": _("Warped+"),
        "deathChanceMultiple": 0.40,
        "image": arch13w,
        "blinkImage": arch13w_blink,
        "additionalRewardCandidates": 2,
        "isNormal": false
    },
    {
        "id": 36,
        "warpedId": 36,
        "name": unicodeToStringCode(warpedJamesTheBearName),
        "rarity": _("Warped++"),
        "deathChanceMultiple": 0.30,
        "image": arch14w,
        "blinkImage": arch14w_blink,
        "additionalRewardCandidates": 4,
        "isNormal": false
    },
    {
        "id": 37,
        "warpedId": 37,
        "name": unicodeToStringCode(warpedDennisName),
        "rarity": _("Warped"),
        "deathChanceMultiple": 0.75,
        "image": arch17w,
        "blinkImage": arch17w_blink,
        "additionalRewardCandidates": 1,
        "isNormal": false
    }
];
...
function unlockScientistOfId(scientistId) {
    ...
    if (slotToAdd >= scientistSlots) {
        ...
        return {
            "success": false,
            "reason": _("Scientists Inventory Full")
        };
    }
...
function determineDeathForExcavationChoice(scientistIndex, excavationIndex) {
    ...
    if (!willDie) {
        ...
        return {
            "time": deathTime,
            "reasonIndex": scientistRoller.rand(0, deathReasons.length - 1)
        };
    }
}
...
function getActiveExcavationRewardValues(scientistIndex) {
    ...
    if (isRewardShown || isExcavationDone(scientistIndex)) {
        return {
            ...
            "image": rewardImagecurrentlyViewedDepth,
            "id": rewardId
        };
    } else {
        return {
...
function canClaimRewardForFinishedExcavation(scientistIndex) {
    ...
    if (excavationRewards[rewardId].isRelic) {
        if (!isRelicInventoryFull()) {
            ...
            return {
                "success": false,
                "reason": _("Relic Inventory Is Full, Delete a Relic to claim")
            };
        }
    }
    return {
...
function grantMoneyMinutes(minutes) {
    ...
    var rewardMoney = doBigIntDecimalMultiplication(60 n * valueOfMineralsPerSecond() * 60 n, hours);
...
function grantMineralsForHour(mineralId, hours, displayNews = true) {
    var moneyMadeInTime = doBigIntDecimalMultiplication(60 n * valueOfMineralsPerSecond() * 60 n, hours);
...
function scientistsGrantMineralsForMinutes(minutes) {
    ...
    var hours = minutes / 60;
    var moneyMadeInTime = doBigIntDecimalMultiplication(60 n * valueOfMineralsPerSecond() * 60 n, hours);
    var valuePerMineral = 0 n;
    var numMineralsToReward = 0 n;
...
function userReachedUnderground() {
    return depth >= 303;
}

function isBelow600km() {
    return depth < 600;
}

function pikesUnder36hrs() {
    return STAT.getPikeHours() < 36;
}

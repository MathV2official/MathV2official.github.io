...
quest1.moneyReward = 5000 n;
quest1.completionCheck = function() {
    return numGoldOwned() >= 100;
};
quest1.completionPercentFunction = function() {
    return worldResources[GOLD_INDEX].numOwned / 100;
};
quest1.isVisible = function() {
    return true;
};
...
quest2.moneyReward = 50000 n;
quest2.isVisible = function() {
    return true;
};
quest2.additionalOnClick = function() {
    showSimpleInput(_("Send this message to a friend to share the game with them!") + " <br> <br> " + _("* Please allow up to 30min for this to complete after sharing"), _("Copy Message"), generateShareText(), () => {
        copyShareText();
        shareMouseDown(true);
    }, _("Cancel"), 0, () => {
...
quest3.moneyReward = 20000 n;
quest3.completionCheck = function() {
    return playtime >= 7200;
};
quest3.completionPercentFunction = function() {
    return playtime / 7200;
};
quest3.isVisible = function() {
    return true;
};
...
quest4.moneyReward = 5000 n;
quest4.completionCheck = function() {
    return depth >= 20;
};
quest4.completionPercentFunction = function() {
    return depth / 20;
};
quest4.isVisible = function() {
    return true;
};
...
quest5.moneyReward = 12500 n;
quest5.completionCheck = function() {
    return depth >= 40;
};
quest5.completionPercentFunction = function() {
    return depth / 40;
};
quest5.isVisible = function() {
    return questManager.isQuestComplete(3);
};
...
quest6.moneyReward = 1250000 n;
quest6.completionCheck = function() {
    return chestService.userHasFoundGoldenChest();
};
quest6.isVisible = function() {
    return true;
};
...
quest7.moneyReward = 1250000 n;
quest7.completionCheck = function() {
    return hasFoundGolem == 1 && depth >= 50;
};
quest7.isVisible = function() {
    return true;
};
...
quest8.moneyReward = 1250000 n;
quest8.completionCheck = function() {
    return drillWattage() > 10000 n;
};
quest8.completionPercentFunction = function() {
    return divideBigIntToDecimalNumber(drillWattage(), 10000 n);
};
quest8.isVisible = function() {
    return true;
};
...
quest9.completionCheck = function() {
    return playtime > 86400;
};
quest9.completionPercentFunction = function() {
    return playtime / 86400;
};
quest9.isVisible = function() {
    return questManager.isQuestComplete(2);
};
...
quest10.moneyReward = 2000000 n;
quest10.completionCheck = function() {
    return getEarth().workersHired >= 10;
};
quest10.completionPercentFunction = function() {
    return getEarth().workersHired / 10;
};
quest10.isVisible = function() {
    return true;
};
...
quest11.moneyReward = 100000000 n;
quest11.completionCheck = function() {
    return money >= 1000000000 n;
};
quest11.completionPercentFunction = function() {
    return divideBigIntToDecimalNumber(money, 1000000000 n);
}
quest11.isVisible = function() {
    return true;
};
...
quest12.moneyReward = 125000000 n;
quest12.completionCheck = function() {
    return depth >= 70;
};
quest12.completionPercentFunction = function() {
    return depth / 70;
};
quest12.isVisible = function() {
    return questManager.isQuestComplete(4);
};
...
quest13.moneyReward = 150000000 n;
quest13.completionCheck = function() {
    return drillWattage() >= 10000000 n;
};
quest13.completionPercentFunction = function() {
    return divideBigIntToDecimalNumber(drillWattage(), 10000000 n);
};
quest13.isVisible = function() {
    return questManager.isQuestComplete(7);
};
...
quest14.moneyReward = 500000000 n;
quest14.completionCheck = function() {
    return depth >= 100;
};
quest14.completionPercentFunction = function() {
    return depth / 100;
};
quest14.isVisible = function() {
    return questManager.isQuestComplete(11);
};
...
quest15.moneyReward = 500000000 n;
quest15.completionCheck = function() {
    return numQuestsCompleted() >= 20;
};
quest15.completionPercentFunction = function() {
    return numQuestsCompleted() / 20;
};
quest15.isVisible = function() {
    return true;
};
...
quest16.moneyReward = 100000000000 n;
quest16.completionCheck = function() {
    return depth >= 303;
};
quest16.completionPercentFunction = function() {
    return depth / 303;
};
quest16.isVisible = function() {
    return depth >= 60;
}; //Need to consider when this quest shows up as visible
...
quest17.moneyReward = 500000000000 n;
quest17.completionCheck = function() {
    return monsterskilled >= 100;
};
quest17.completionPercentFunction = function() {
    return monsterskilled / 100;
};
quest17.isVisible = function() {
    return questManager.isQuestComplete(15);
}; //should this and other quests unlock when they reach the underground or when they collect the reached underground achievement?
...
quest18.moneyReward = 500000000000 n;
quest18.completionCheck = function() {
    return numOilOwned() >= 4;
};
quest18.completionPercentFunction = function() {
    return numOilOwned() / 4;
};
quest18.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest19.moneyReward = 250000000000 n;
quest19.completionCheck = function() {
    return battleInventory[0][4] >= 3;
};
quest19.completionPercentFunction = function() {
    return battleInventory[0][4] / 3;
};
quest19.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest20.moneyReward = 500000000000 n;
quest20.completionCheck = function() {
    return oilrigStructure.level >= 6;
};
quest20.completionPercentFunction = function() {
    return oilrigStructure.level / 6;
};
quest20.isVisible = function() {
    return questManager.isQuestComplete(17);
};
...
quest21.additionalOnClick = function() {
    reviewMouseDown();
    checkReview();
};
quest21.rewardType = REWARD_TYPE_GOLD_CHEST;
quest21.moneyReward = 100000000000 n;
quest21.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest22.moneyReward = 500000000000 n;
quest22.completionCheck = function() {
    return bossesDefeated >= 3;
};
quest22.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest23.completionCheck = function() {
    return hasLegendaryScientist();
};
quest23.isVisible = function() {
    return hasUnlockedScientists > 0;
};
...
quest24.moneyReward = 500000000000 n;
quest24.completionCheck = function() {
    return has4Weapons();
};
quest24.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest25.moneyReward = 750000000000 n;
quest25.completionCheck = function() {
    return deadScientists >= 30;
};
quest25.completionPercentFunction = function() {
    return deadScientists / 30;
};
quest25.isVisible = function() {
    return deadScientists > 0;
};
...
quest26.moneyReward = 750000000000 n;
quest26.completionCheck = function() {
    return purpleForgedGem.numOwned > 0;
};
quest26.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest27.moneyReward = 2000000000000 n;
quest27.completionCheck = function() {
    return yellowForgedGem.numOwned > 0;
};
quest27.isVisible = function() {
    return questManager.isQuestComplete(25);
};
...
quest28.moneyReward = 2000000000000 n;
quest28.completionCheck = function() {
    return getTotalDps() >= 50;
};
quest28.completionPercentFunction = function() {
    return getTotalDps() / 50;
};
quest28.isVisible = function() {
    return questManager.isQuestComplete(18);
};
...
quest29.moneyReward = 2000000000000 n;
quest29.completionCheck = function() {
    return mineralsSacrificed >= 50000000000;
};
quest29.completionPercentFunction = function() {
    return mineralsSacrificed / 50000000000;
};
quest29.isVisible = function() {
    return questManager.isQuestComplete(15) && depth >= 500;
};
...
quest30.moneyReward = 5000000000000 n;
quest30.completionCheck = function() {
    return hasLevel30Scientists() && questManager.isQuestComplete(15);
};
quest30.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest31.moneyReward = 50000000000000 n;
quest31.completionCheck = function() {
    return depth >= 1032;
};
quest31.completionPercentFunction = function() {
    return depth / 1032;
};
quest31.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest32.moneyReward = 500000000000000 n;
quest32.completionCheck = function() {
    return whackosKilled > 0;
};
quest32.isVisible = function() {
    return questManager.isQuestComplete(30);
};
...
quest33.moneyReward = 500000000000000 n;
quest33.completionCheck = function() {
    return reactor.totalRuntimeSecs > 0;
};
quest33.isVisible = function() {
    return questManager.isQuestComplete(30);
};
...
quest34.moneyReward = 250000000000000000 n;
quest34.completionCheck = function() {
    return reactorStructure.level >= 5;
};
quest34.completionPercentFunction = function() {
    return reactorStructure.level / 5;
};
quest34.isVisible = function() {
    return questManager.isQuestComplete(32);
};
...
quest35.moneyReward = 12500000000000000 n;
quest35.completionCheck = function() {
    return bufflab.totalBuffsCasted > 0;
};
quest35.isVisible = function() {
    return questManager.isQuestComplete(32);
};
...
quest36.moneyReward = 25000000000000000 n;
quest36.completionCheck = function() {
    return ((bufflab.totalSecsBuffed / 60.0) / 60.0) > 24.0;
};
quest36.completionPercentFunction = function() {
    return bufflab.totalSecsBuffed / (60 * 60 * 24);
};
quest36.isVisible = function() {
    return questManager.isQuestComplete(34);
};
...
quest37.completionCheck = function() {
    return numDiamondOwned() > 0;
};
quest37.isVisible = function() {
    return true;
};
...
quest38.completionCheck = function() {
    return totalCompletedTrades > 0;
};
quest38.isVisible = function() {
    return true;
};
...
quest57.completionCheck = function() {
    return totalCompletedTrades >= 5;
};
quest57.isVisible = function() {
    return questManager.isQuestComplete(38);
};
...
quest58.completionCheck = function() {
    return totalCompletedTrades >= 50;
};
quest58.isVisible = function() {
    return questManager.isQuestComplete(38);
};
...
quest59.completionCheck = function() {
    return totalCompletedTrades >= 250;
};
quest59.isVisible = function() {
    return questManager.isQuestComplete(38);
};
...
quest77.completionCheck = function() {
    return getEarth().workerLevel >= 5;
};
quest77.completionPercentFunction = function() {
    return getEarth().workerLevel / 5;
}
quest77.isVisible = function() {
    return getEarth().workersHired >= 10;
};
...
quest40.completionCheck = function() {
    return metalDetectorStructure.level > 0;
};
quest40.isVisible = function() {
    return true;
};
...
quest39.completionCheck = function() {
    return managerStructure.level > 0;
};
quest39.isVisible = function() {
    return true;
};
...
quest64.completionCheck = function() {
    return numGameLaunches > 1;
};
quest64.isVisible = function() {
    return false;
};
...
quest42.completionCheck = function() {
    return numRelicsEquipped() > 0;
};
quest42.isVisible = function() {
    return true;
};
...
quest41.completionCheck = function() {
    return numCavesCompleted > 0;
};
quest41.rewardType = REWARD_TYPE_BUILDING_MATERIALS;
quest41.rewardAmount = 2;
quest41.isVisible = function() {
    return true;
};
...
quest69.completionCheck = function() {
    return numCavesCompleted >= 10;
};
quest69.completionPercentFunction = function() {
    return numCavesCompleted / 10;
};
quest69.isVisible = function() {
    return questManager.isQuestComplete(48);
};
...
quest60.completionCheck = function() {
    return money >= 1000000000000 n;
};
quest60.completionPercentFunction = function() {
    return divideBigIntToDecimalNumber(money, 1000000000000 n);
}
quest60.isVisible = function() {
    return questManager.isQuestComplete(10);
};
...
quest67.completionCheck = function() {
    return totalMoneyEarnedSession >= 1000000000000000 n;
};
quest67.completionPercentFunction = function() {
    return divideBigIntToDecimalNumber(totalMoneyEarnedSession, 1000000000000000 n);
};
quest67.isVisible = function() {
    return totalMoneyEarnedSession >= 1000000000000 n;
};
...
quest61.completionCheck = function() {
    return money >= 1000000000000000000 n;
};
quest61.completionPercentFunction = function() {
    return divideBigIntToDecimalNumber(money, 1000000000000000000 n);
}
quest61.isVisible = function() {
    return questManager.isQuestComplete(59);
};
...
quest75.completionCheck = function() {
    return worldResources[URANIUM3_INDEX].numOwned >= 1;
};
quest75.isVisible = function() {
    return true;
};
...
quest76.completionCheck = function() {
    return worldResources[POLONIUM3_INDEX].numOwned >= 1;
};
quest76.isVisible = function() {
    return true;
};
...
quest56.completionCheck = function() {
    return worldResources[EINSTEINIUM3_INDEX].numOwned > 0;
};
quest56.isVisible = function() {
    return depth >= getMoon().startDepth;
};
...
quest89.completionCheck = function() {
    return numCaliforniumOwned() >= 1;
};
quest89.isVisible = function() {
    return questManager.isQuestComplete(15);
};
...
quest83.completionCheck = function() {
    return worldResources[TITANIUM_INDEX].numOwned >= 1;
};
quest83.isVisible = function() {
    return depth >= getMoon().startDepth;
};
...
quest74.completionCheck = function() {
    return worldResources[PROMETHIUM_INDEX].numOwned >= 1;
};
quest74.isVisible = function() {
    return questManager.isQuestComplete(61);
};
...
quest90.completionCheck = function() {
    return worldResources[YTTERBIUM_INDEX].numOwned >= 1;
};
quest90.isVisible = function() {
    return questManager.isQuestComplete(62);
};
...
quest46.completionCheck = function() {
    return hasFoundGidget == 1;
};
quest46.isVisible = function() {
    return true;
};
...
quest53.completionCheck = function() {
    return depth >= 501;
};
quest53.completionPercentFunction = function() {
    return depth / 501;
};
quest53.isVisible = function() {
    return depth >= 303;
}; //Need to consider when this quest shows up as visible
...
quest54.completionCheck = function() {
    return depth >= 750;
};
quest54.completionPercentFunction = function() {
    return depth / 750;
};
quest54.isVisible = function() {
    return depth >= 501;
}; //Need to consider when this quest shows up as visible
...
quest55.completionCheck = function() {
    return depth >= getTitan().startDepth;
};
quest55.completionPercentFunction = function() {
    return depth / getTitan().startDepth;
};
quest55.isVisible = function() {
    return depth >= 1032;
};
...
quest44.completionCheck = function() {
    return playtime > (86400 * 7);
};
quest44.completionPercentFunction = function() {
    return playtime / (86400 * 7);
};
quest44.isVisible = function() {
    return questManager.isQuestComplete(8);
};
...
quest85.completionCheck = function() {
    return questManager.isQuestComplete(8) && timelapseMinutesInSession > (60 * 24 * 3);
};
quest85.completionPercentFunction = function() {
    return timelapseMinutesInSession / (60 * 24 * 3);
};
quest85.isVisible = function() {
    return true;
};
...
quest47.completionCheck = function() {
    return chestCollectorStorageStructure.level >= 3;
};
quest47.completionPercentFunction = function() {
    return chestCollectorStorageStructure.level / 3;
};
quest47.isVisible = function() {
    return true;
};
...
quest48.completionCheck = function() {
    return managerStructure.level >= 3;
};
quest48.completionPercentFunction = function() {
    return managerStructure.level / 3;
};
quest48.isVisible = function() {
    return questManager.isQuestComplete(38);
};
...
quest62.completionCheck = function() {
    return orangeFishCollected > 0;
};
quest62.isVisible = function() {
    return true;
};
...
quest66.completionCheck = function() {
    return chestService.totalBasicChestsOpened >= 1000;
};
quest66.completionPercentFunction = function() {
    return chestService.totalBasicChestsOpened / 1000;
}
quest66.isVisible = function() {
    return chestService.totalBasicChestsOpened > 100;
};
...
quest70.completionCheck = function() {
    return chestService.totalGoldChestsOpened >= 100;
};
quest70.completionPercentFunction = function() {
    return chestService.totalGoldChestsOpened / 100;
}
quest70.isVisible = function() {
    return chestService.totalGoldChestsOpened > 10;
};
...
quest71.completionCheck = function() {
    return totalTimeLapsedMinutes >= (60 * 24 * 7);
};
quest71.completionPercentFunction = function() {
    return totalTimeLapsedMinutes / (60 * 24 * 7);
}
quest71.isVisible = function() {
    return totalTimeLapsedMinutes >= (60 * 24 * 1);
};
...
quest72.completionCheck = function() {
    return totalTimeLapsedMinutes >= (60 * 24 * 365);
};
quest72.completionPercentFunction = function() {
    return totalTimeLapsedMinutes / (60 * 24 * 365);
}
quest72.isVisible = function() {
    return totalTimeLapsedMinutes >= (60 * 24 * 7);
};
...
quest81.completionCheck = function() {
    return monsterskilled > 0;
};
quest81.isVisible = function() {
    return depth >= 303;
};
...
quest91.completionCheck = function() {
    ...
    blueprintsInCategory = filterBlueprints(blueprintsInCategory, function(blueprint) {
        return blueprint.craftedItem.item.isAtMaxLevel();
    });
    return blueprintsInCategory.length > 0;
};
quest91.isVisible = function() {
    return questManager.isQuestComplete(88);
};
...
quest78.completionCheck = function() {
    return oilrigStructure.level >= 14;
};
quest78.completionPercentFunction = function() {
    return oilrigStructure.level / 14;
}
quest78.isVisible = function() {
    return depth >= 303;
};
...
quest86.completionCheck = function() {
    return numBuildingMaterialsOwned() >= 1000;
};
quest86.completionPercentFunction = function() {
    return numBuildingMaterialsOwned() / 1000;
};
quest86.isVisible = function() {
    return true;
};
...
quest84.completionCheck = function() {
    return drillWattage() >= 10000000000000 n;
};
quest84.completionPercentFunction = function() {
    return divideBigIntToDecimalNumber(drillWattage(), 10000000000000 n);
};
quest84.isVisible = function() {
    return questManager.isQuestComplete(12);
};
...
quest79.completionCheck = function() {
    return reactor.grid.cachedEnergyPerSecond >= 300 && reactor.isAbleToRun();
};
quest79.completionPercentFunction = function() {
    return reactor.grid.cachedEnergyPerSecond / 300;
}
quest79.isVisible = function() {
    return questManager.isQuestComplete(32);
};
...
quest80.completionCheck = function() {
    return reactor.currentBatteryCharge() >= 5000000;
};
quest80.completionPercentFunction = function() {
    return reactor.currentBatteryCharge() / 5000000;
}
quest80.isVisible = function() {
    return questManager.isQuestComplete(32);
};
...
quest63.completionCheck = function() {
    return numStoredNuclearEnergyOwned() > 10000000;
};
quest63.completionPercentFunction = function() {
    return numStoredNuclearEnergyOwned() / 10000000;
}
quest63.isVisible = function() {
    return questManager.isQuestComplete(32);
};
...
quest65.completionCheck = function() {
    return getMoon().workersHired >= 10;
};
quest65.completionPercentFunction = function() {
    return getMoon().workersHired / 10;
}
quest65.isVisible = function() {
    return depth > getMoon().startDepth;
};
...
quest73.completionCheck = function() {
    return deadScientists >= 10;
};
quest73.completionPercentFunction = function() {
    return deadScientists / 10;
}
quest73.isVisible = function() {
    return deadScientists > 0;
};
...
quest51.completionCheck = function() {
    return numScientistsSacrificed > 0;
};
quest51.isVisible = function() {
    return depth >= 501;
};
...
quest92.completionCheck = function() {
    return isCoreWarped || isCoreBlessed;
};
quest92.isVisible = function() {
    return false;
};
...
quest97.completionCheck = function() {
    return superMinerManager.recievedInitialSuperMiner;
};
quest97.isVisible = function() {
    return true;
};
...
quest98.completionCheck = function() {
    return superMinerManager.currentSuperMiners.filter(miner => miner.rarity == superMinerRarities.legendary).length > 0;
};
quest98.isVisible = function() {
    return true;
};
...
quest99.completionCheck = function() {
    return chestService.totalBlackChestsOpened >= 100;
};
quest99.completionPercentFunction = function() {
    return chestService.totalBlackChestsOpened / 100;
};
quest99.isVisible = function() {
    return true;
};
...
quest100.completionCheck = function() {
    return superMinerManager.currentSuperMiners.filter(miner => miner.isMaxLevel()).length > 0;
};
quest100.isVisible = function() {
    return true;
};
...
function shareMouseDown(showFriends = true) {
    ...
    setTimeout(function() {
        questManager.getQuest(1).isComplete = true;
    }, 1200 * 1000);
}
...
function checkReview() {
    setTimeout(function() {
        questManager.getQuest(20).isComplete = true;
    }, 2000);
}
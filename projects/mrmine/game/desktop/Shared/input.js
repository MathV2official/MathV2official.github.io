...
if (!isMobile()) {
    ...
    document.getElementById('METALDETECTORPLACE').onmouseleave = function() {
        hideTooltip();
    }
    ...
    document.getElementById('PLACE1').onclick = function() {
        if (!isMobile()) openUi(SellWindow, null, EARTH_INDEX);
    }
    document.getElementById('PLACE2').onclick = function() {
        if (!isMobile()) openUi(HireWindow, null, EARTH_INDEX);
    }

    document.getElementById('PLACE3').onclick = function() {
        if (!isMobile()) openUi(CraftingWindow);
    }
    ...
    document.getElementById('PLACE4').onclick = function() {
        if (!isMobile()) openUi(QuestWindow);
    }

    document.getElementById('ARCHPLACE').onclick = function() {
        if (!isMobile() && hasUnlockedScientists) {
            openUi(ScientistsWindow);
        }
    }
    document.getElementById('drillHitbox').onmouseover = function() {
        if (BattleManager.isStalledDueToBoss()) {
            showTooltip(_("Drill Stalled"), _("Defeat the boss at {0}km to progress.", BattleManager.depthOfDeepestBossReached()), "82%", "70%");
        }
        if (isWaitingForLiftoff()) {
            showTooltip(_("Drill"), _("Your drill is waiting for your command to lift off."), "82%", "75%");
        }
        if (depth < 20) {
            showTooltip(_("Drill"), _("Upgrade your drill by crafting blueprints. Upgrading your drill increases its digging speed."), "82%", "75%");
        }
    }
    ...
    document.getElementById('LOGGERTAB1').onclick = function() {
        windowState[11] = 1;
    }
    document.getElementById('LOGGERTAB2').onclick = function() {
        windowState[11] = 2;
    }
}
...
if (!isMobile()) {
    document.getElementById('GARAGE').onmouseover = function() {
        isHoveringOverGarage = 1;
    }
    document.getElementById('GARAGE').onmouseout = function() {
        isHoveringOverGarage = 0;
    }
    ...
    document.getElementById('CLOSEl2').onclick = function() {
        logui(0);
    }

    document.getElementById('G7i').onclick = function() {
        showImportPopup();
    }
    document.getElementById('G7i').onmouseover = function() {
        showTooltip(_("Import game"), _("Import a game save using an import code. Only compatible with codes from Steam MrMine."), "20%", "80%");
    }
    document.getElementById('G7i').onmouseout = function() {
        hideTooltip();
    }
    document.getElementById('steamCloudBackup').onclick = function() {
        displayCloudBackups();
    }
    document.getElementById('steamCloudBackup').onmouseover = function() {
        showTooltipForDiv(_("Access Steam Backups"), "", "steamCloudBackup");
    }
    document.getElementById('steamCloudBackup').onmouseout = function() {
        hideTooltip();
    }
    document.getElementById('languageSelection').onclick = function() {
        showLanguageSelection();
    }
    document.getElementById('languageSelection').onmouseover = function() {
        showTooltipForDiv(_("Select Language") + " (Select Language)", "", "languageSelection");
    }
    document.getElementById('languageSelection').onmouseout = function() {
        hideTooltip();
    }
    document.getElementById('CLOSEhe').onclick = function() {
        helpui(0);
    }

    document.getElementById('PAGES1').onclick = function() {
        drillPurchasePage = 0;
    }
    document.getElementById('PAGES2').onclick = function() {
        drillPurchasePage = 1;
    }
    document.getElementById('PAGES3').onclick = function() {
        drillPurchasePage = 2;
    }
    document.getElementById('PAGES4').onclick = function() {
        drillPurchasePage = 3;
    }
    document.getElementById('PAGES5').onclick = function() {
        drillPurchasePage = 4;
    }
    document.getElementById('PAGES6').onclick = function() {
        drillPurchasePage = 5;
    }

    document.getElementById('L5a').onclick = function() {
        onWorkerClicked(5, 1);
    }
    document.getElementById('L5b').onclick = function() {
        onWorkerClicked(5, 2);
    }
    document.getElementById('L5c').onclick = function() {
        onWorkerClicked(5, 3);
    }
    document.getElementById('L5d').onclick = function() {
        onWorkerClicked(5, 4);
    }
    document.getElementById('L5e').onclick = function() {
        onWorkerClicked(5, 5);
    }
    document.getElementById('L5f').onclick = function() {
        onWorkerClicked(5, 6);
    }
    document.getElementById('L5g').onclick = function() {
        onWorkerClicked(5, 7);
    }
    document.getElementById('L5h').onclick = function() {
        onWorkerClicked(5, 8);
    }
    document.getElementById('L5i').onclick = function() {
        onWorkerClicked(5, 9);
    }
    document.getElementById('L5j').onclick = function() {
        onWorkerClicked(5, 10);
    }
    document.getElementById('L4a').onclick = function() {
        onWorkerClicked(4, 1);
    }
    document.getElementById('L4b').onclick = function() {
        onWorkerClicked(4, 2);
    }
    document.getElementById('L4c').onclick = function() {
        onWorkerClicked(4, 3);
    }
    document.getElementById('L4d').onclick = function() {
        onWorkerClicked(4, 4);
    }
    document.getElementById('L4e').onclick = function() {
        onWorkerClicked(4, 5);
    }
    document.getElementById('L4f').onclick = function() {
        onWorkerClicked(4, 6);
    }
    document.getElementById('L4g').onclick = function() {
        onWorkerClicked(4, 7);
    }
    document.getElementById('L4h').onclick = function() {
        onWorkerClicked(4, 8);
    }
    document.getElementById('L4i').onclick = function() {
        onWorkerClicked(4, 9);
    }
    document.getElementById('L4j').onclick = function() {
        onWorkerClicked(4, 10);
    }
    document.getElementById('L3a').onclick = function() {
        onWorkerClicked(3, 1);
    }
    document.getElementById('L3b').onclick = function() {
        onWorkerClicked(3, 2);
    }
    document.getElementById('L3c').onclick = function() {
        onWorkerClicked(3, 3);
    }
    document.getElementById('L3d').onclick = function() {
        onWorkerClicked(3, 4);
    }
    document.getElementById('L3e').onclick = function() {
        onWorkerClicked(3, 5);
    }
    document.getElementById('L3f').onclick = function() {
        onWorkerClicked(3, 6);
    }
    document.getElementById('L3g').onclick = function() {
        onWorkerClicked(3, 7);
    }
    document.getElementById('L3h').onclick = function() {
        onWorkerClicked(3, 8);
    }
    document.getElementById('L3i').onclick = function() {
        onWorkerClicked(3, 9);
    }
    document.getElementById('L3j').onclick = function() {
        onWorkerClicked(3, 10);
    }
    document.getElementById('L2a').onclick = function() {
        onWorkerClicked(2, 1);
    }
    document.getElementById('L2b').onclick = function() {
        onWorkerClicked(2, 2);
    }
    document.getElementById('L2c').onclick = function() {
        onWorkerClicked(2, 3);
    }
    document.getElementById('L2d').onclick = function() {
        onWorkerClicked(2, 4);
    }
    document.getElementById('L2e').onclick = function() {
        onWorkerClicked(2, 5);
    }
    document.getElementById('L2f').onclick = function() {
        onWorkerClicked(2, 6);
    }
    document.getElementById('L2g').onclick = function() {
        onWorkerClicked(2, 7);
    }
    document.getElementById('L2h').onclick = function() {
        onWorkerClicked(2, 8);
    }
    document.getElementById('L2i').onclick = function() {
        onWorkerClicked(2, 9);
    }
    document.getElementById('L2j').onclick = function() {
        onWorkerClicked(2, 10);
    }
    document.getElementById('L1a').onclick = function() {
        onWorkerClicked(1, 1);
    }
    document.getElementById('L1b').onclick = function() {
        onWorkerClicked(1, 2);
    }
    document.getElementById('L1c').onclick = function() {
        onWorkerClicked(1, 3);
    }
    document.getElementById('L1d').onclick = function() {
        onWorkerClicked(1, 4);
    }
    document.getElementById('L1e').onclick = function() {
        onWorkerClicked(1, 5);
    }
    document.getElementById('L1f').onclick = function() {
        onWorkerClicked(1, 6);
    }
    document.getElementById('L1g').onclick = function() {
        onWorkerClicked(1, 7);
    }
    document.getElementById('L1h').onclick = function() {
        onWorkerClicked(1, 8);
    }
    document.getElementById('L1i').onclick = function() {
        onWorkerClicked(1, 9);
    }
    document.getElementById('L1j').onclick = function() {
        onWorkerClicked(1, 10);
    }
    document.getElementById('L5gap1').onclick = function() {
        clickedGap(5, 1);
    }
    document.getElementById('L5gap2').onclick = function() {
        clickedGap(5, 2);
    }
    document.getElementById('L5gap3').onclick = function() {
        clickedGap(5, 3);
    }
    document.getElementById('L5gap4').onclick = function() {
        clickedGap(5, 4);
    }
    document.getElementById('L5gap5').onclick = function() {
        clickedGap(5, 5);
    }
    document.getElementById('L5gap6').onclick = function() {
        clickedGap(5, 6);
    }
    document.getElementById('L5gap7').onclick = function() {
        clickedGap(5, 7);
    }
    document.getElementById('L5gap8').onclick = function() {
        clickedGap(5, 8);
    }
    document.getElementById('L5gap9').onclick = function() {
        clickedGap(5, 9);
    }
    document.getElementById('L5gap10').onclick = function() {
        clickedGap(5, 10);
    }
    document.getElementById('L5gap11').onclick = function() {
        clickedGap(5, 11);
    }
    document.getElementById('L4gap1').onclick = function() {
        clickedGap(4, 1);
    }
    document.getElementById('L4gap2').onclick = function() {
        clickedGap(4, 2);
    }
    document.getElementById('L4gap3').onclick = function() {
        clickedGap(4, 3);
    }
    document.getElementById('L4gap4').onclick = function() {
        clickedGap(4, 4);
    }
    document.getElementById('L4gap5').onclick = function() {
        clickedGap(4, 5);
    }
    document.getElementById('L4gap6').onclick = function() {
        clickedGap(4, 6);
    }
    document.getElementById('L4gap7').onclick = function() {
        clickedGap(4, 7);
    }
    document.getElementById('L4gap8').onclick = function() {
        clickedGap(4, 8);
    }
    document.getElementById('L4gap9').onclick = function() {
        clickedGap(4, 9);
    }
    document.getElementById('L4gap10').onclick = function() {
        clickedGap(4, 10);
    }
    document.getElementById('L4gap11').onclick = function() {
        clickedGap(4, 11);
    }
    document.getElementById('L3gap1').onclick = function() {
        clickedGap(3, 1);
    }
    document.getElementById('L3gap2').onclick = function() {
        clickedGap(3, 2);
    }
    document.getElementById('L3gap3').onclick = function() {
        clickedGap(3, 3);
    }
    document.getElementById('L3gap4').onclick = function() {
        clickedGap(3, 4);
    }
    document.getElementById('L3gap5').onclick = function() {
        clickedGap(3, 5);
    }
    document.getElementById('L3gap6').onclick = function() {
        clickedGap(3, 6);
    }
    document.getElementById('L3gap7').onclick = function() {
        clickedGap(3, 7);
    }
    document.getElementById('L3gap8').onclick = function() {
        clickedGap(3, 8);
    }
    document.getElementById('L3gap9').onclick = function() {
        clickedGap(3, 9);
    }
    document.getElementById('L3gap10').onclick = function() {
        clickedGap(3, 10);
    }
    document.getElementById('L3gap11').onclick = function() {
        clickedGap(3, 11);
    }
    document.getElementById('L2gap1').onclick = function() {
        clickedGap(2, 1);
    }
    document.getElementById('L2gap2').onclick = function() {
        clickedGap(2, 2);
    }
    document.getElementById('L2gap3').onclick = function() {
        clickedGap(2, 3);
    }
    document.getElementById('L2gap4').onclick = function() {
        clickedGap(2, 4);
    }
    document.getElementById('L2gap5').onclick = function() {
        clickedGap(2, 5);
    }
    document.getElementById('L2gap6').onclick = function() {
        clickedGap(2, 6);
    }
    document.getElementById('L2gap7').onclick = function() {
        clickedGap(2, 7);
    }
    document.getElementById('L2gap8').onclick = function() {
        clickedGap(2, 8);
    }
    document.getElementById('L2gap9').onclick = function() {
        clickedGap(2, 9);
    }
    document.getElementById('L2gap10').onclick = function() {
        clickedGap(2, 10);
    }
    document.getElementById('L2gap11').onclick = function() {
        clickedGap(2, 11);
    }
    document.getElementById('L1gap1').onclick = function() {
        clickedGap(1, 1);
    }
    document.getElementById('L1gap2').onclick = function() {
        clickedGap(1, 2);
    }
    document.getElementById('L1gap3').onclick = function() {
        clickedGap(1, 3);
    }
    document.getElementById('L1gap4').onclick = function() {
        clickedGap(1, 4);
    }
    document.getElementById('L1gap5').onclick = function() {
        clickedGap(1, 5);
    }
    document.getElementById('L1gap6').onclick = function() {
        clickedGap(1, 6);
    }
    document.getElementById('L1gap7').onclick = function() {
        clickedGap(1, 7);
    }
    document.getElementById('L1gap8').onclick = function() {
        clickedGap(1, 8);
    }
    document.getElementById('L1gap9').onclick = function() {
        clickedGap(1, 9);
    }
    document.getElementById('L1gap10').onclick = function() {
        clickedGap(1, 10);
    }
    document.getElementById('L1gap11').onclick = function() {
        clickedGap(1, 11);
    }
}
...
if (!isMobile()) {
    ...
    document.getElementById('G1').onmouseout = function() {
        saveButtons[0] = 0;
    }
    document.getElementById('G2').onmouseout = function() {
        saveButtons[1] = 0;
    }
    document.getElementById('G3').onmouseout = function() {
        saveButtons[2] = 0;
    }

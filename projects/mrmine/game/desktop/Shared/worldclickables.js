...
function onSpawnMineralDeposit() {
    ...
    if (!isClickableAtDepth(depthToSpawn) && isSpawnableAtDepth(depthToSpawn)) {
        ...
        var moneyGeneratedPerMinute = valueOfMineralsPerSecond() * 60 n;
        ...
        var numMineralsToSpawn = bigIntMin(500000000 n, bigIntMax(BigInt(parseInt(numMineralsToSpawnCandidate1)), numMineralsToSpawnCandidate2));
        var numMineralPerClick = parseInt(numMineralsToSpawn / 5 n);
...
function onClickedOrangeFish(clickableObject) {
    ...
    if (clickableObject.clicks < clickableObject.maxClicks) {
        ...
        switch (clickableRoller.rand(0, 4)) {
            case 0:
                //money
                var moneyGranted = valueOfMineralsPerSecond() * 60 n * BigInt(parseInt(minutesOfValue));

...
(function() {
    ...
    I.ViewGame = function() {
        ...
        function ViewGame(el, game1, opts1) {
            ...
            this.download_upload = bind(this.download_upload, this);
            I.event2("view game", {
            ...
            this.el.dispatch("click", {
                ...
                download_btn: function(_this) {
                    return function(btn) {
                        ...
                        return _this.download_upload(btn.data("upload_id"), opts)
                    }
                }(this),
                buy_btn: function(_this) {
                    return function(btn) {
        ...
        ViewGame.prototype.download_upload = function(upload_id, _opts) {
            var opts;
            opts = $.extend({
                source: "view_game",
                as_props: "1"
            }, _opts);
            if (I.bypass_quarantine) {
                opts.bypass_quarantine = true
            }
            return I.prepare_download(this.game.slug, upload_id, null, function(_this) {
                return function(url, res) {
                    if (res.lightbox) {
                        switch (res.lightbox_type) {
                            case "QuarantineLightbox":
                                I.Lightbox.open(R.Game.QuarantineLightbox($.extend({
                                    on_force_download: function() {
                                        return _this.download_upload(upload_id, $.extend({}, _opts, {
                                ...
                                break;
                            default:
                                I.Lightbox.open(R.AfterDownloadLightbox(res.lightbox))
                        }
                    }
                    if (I.start_download(res)) {
                        I.event("view_game", "download", "" + _this.game.id);
                        I.ConversionTracker.download("1:" + _this.game.id);
                        return I.ConversionTracker.flush_now()
                    }
                }
            }(this), opts)
        };
        ...
        ViewGame.prototype.setup_uploads = function() {
            ...
            for (i = 0, len = ref1.length; i < len; i++) {
                ...
                results.push(size.html(I.format_bytes(parseInt(size.html()))))
            }
            return results
        };
...
(function() {
    I.libs.react.done(function() {
        var P, _rdf, a, abbr, br, button, code, details, div, em, fieldset, form, fragment, h1, h2, h3, h4, h5, h6, iframe, img, input, label, legend, li, ol, optgroup, option, p, pre, section, select, span, strong, summary, textarea, types, ul;
        _rdf = ReactDOMFactories;
        div = _rdf.div, span = _rdf.span, a = _rdf.a, br = _rdf.br, p = _rdf.p, ol = _rdf.ol, ul = _rdf.ul, li = _rdf.li, strong = _rdf.strong, em = _rdf.em, img = _rdf.img, form = _rdf.form, label = _rdf.label, input = _rdf.input, textarea = _rdf.textarea, button = _rdf.button, iframe = _rdf.iframe, h1 = _rdf.h1, h2 = _rdf.h2, h3 = _rdf.h3, h4 = _rdf.h4, h5 = _rdf.h5, h6 = _rdf.h6, pre = _rdf.pre, code = _rdf.code, select = _rdf.select, option = _rdf.option, section = _rdf.section, optgroup = _rdf.optgroup, fieldset = _rdf.fieldset, legend = _rdf.legend;
        fragment = React.createElement.bind(null, React.Fragment);
        fragment.type = React.fragment;
        P = R["package"]("Game");
        types = PropTypes;
        details = ReactDOMFactories.details, summary = ReactDOMFactories.summary, abbr = ReactDOMFactories.abbr;
        P("QuarantineLightbox", {
            pure: true,
            render_timestamp: function(t) {
                return abbr({
                    title: t,
                    className: "datetime"
                }, span({
                    ...
                    "aria-hidden": "true"
                }), " ", I.format_timestamp(t))
            },
            render: function() {
                return R.Lightbox({
                    className: this.enclosing_class_name()
                }, h2({}, "WARNING: This Page Has Been Quarantined"), p({}, strong({}, "Our system has flagged this page for additional review due to potential suspicious behavior from the page owner. ")), p({}, "If someone has asked you to download from this page and you don't fully trust them or their behavior isn't what you recognize then we don't recommend downloading this file until our team has reviewed the page. "), p({}, a({
                    href: "https://itch.io/t/1659440/psa-beware-discord-scammers",
                    className: "forward_link",
                    target: "_blank"
                }, 'Learn more about the recent "Try my game" Discord scam')), section({}, h3({}, "Page and Account Details"), ul({
                    className: "account_summary"
                }, li({}, "Page created ", this.render_timestamp(this.props.game_created_at)), li({}, "Account created ", this.render_timestamp(this.props.user_created_at)), !this.props.user_email_verified ? li({}, "Account's email is not verified") : void 0, this.props.user_email_invalid ? li({}, span({
                    className: "icon icon-warning"
                }), " ", "Account may have fake email address") : void 0, this.props.user_recent_countries ? li({}, "Regions this account has connected from: ", strong({}, new Intl.ListFormat("en").format(this.props.user_recent_countries))) : void 0)), details({}, summary({}, "I understand the risks, let me download anyway..."), div({
                    className: "download_row"
                }, button({
                    type: "button",
                    className: "button",
                    onClick: this.force_download
                }, "Download ", this.props.upload.name ? code({}, this.props.upload.name) : void 0, this.props.upload.size ? span({
                    className: "upload_size"
                }, " (" + I.format_bytes(this.props.upload.size) + ")") : void 0), " Uploaded ", this.render_timestamp(this.props.upload.created_at))), p({
                    className: "buttons"
                }, button({
                    type: "button",
                    className: "button",
                    onClick: this.report_page
                }, "Report this page"), " ", button({
                    type: "button",
                    className: "button outline close_btn"
                }, "Close")))
            },
            report_page: function() {
                return I.Lightbox.open_remote_react(this.props.report_url, function(props) {
                    return R.Game.ReportLightbox(props)
                })
            },
            force_download: function() {
                if (this.props.on_force_download) {
                    return this.props.on_force_download()
                } else {
                    I.bypass_quarantine = true;
                    return I.Lightbox.close()
                }
            }
        })
        ...
        P("ReportLightbox", {
            ...
            get_report_options: function() {
                ...
                out = [
                    ...
                    ["miscategorized", "Miscategorized", "Shows up on wrong part of itch.io, incorrect tags, incorrect platforms, etc."],
                    ["spam", "Spam"],
            ...
            render_after_submit: function() {
                return div({
                    ...
                    href: this.props.itchio_support_url,
                    target: "_blank"
                }, "contact our support team"), "."), this.state.report_id ? p({}, "If you need to talk to itch.io staff about your report please use the following reference code: ", code({}, strong({}, "R-" + this.state.report_id)), ".") : void 0, p({}, button({
                    type: "button",
                    className: "textlike",
                    onClick: function(_this) {
                        return function(e) {
...
(function() {
    I.libs.react.done(function() {
        var Ads, _rdf, a, br, button, code, div, em, fieldset, form, fragment, h1, h2, h3, h4, h5, h6, iframe, img, input, label, legend, li, ol, optgroup, option, p, pre, section, select, span, strong, textarea, ul;
        _rdf = ReactDOMFactories;
        div = _rdf.div, span = _rdf.span, a = _rdf.a, br = _rdf.br, p = _rdf.p, ol = _rdf.ol, ul = _rdf.ul, li = _rdf.li, strong = _rdf.strong, em = _rdf.em, img = _rdf.img, form = _rdf.form, label = _rdf.label, input = _rdf.input, textarea = _rdf.textarea, button = _rdf.button, iframe = _rdf.iframe, h1 = _rdf.h1, h2 = _rdf.h2, h3 = _rdf.h3, h4 = _rdf.h4, h5 = _rdf.h5, h6 = _rdf.h6, pre = _rdf.pre, code = _rdf.code, select = _rdf.select, option = _rdf.option, section = _rdf.section, optgroup = _rdf.optgroup, fieldset = _rdf.fieldset, legend = _rdf.legend;
        fragment = React.createElement.bind(null, React.Fragment);
        fragment.type = React.fragment;
        ...
        Ads("AfterDownload", {
            ...
            render: function() {
                return div({}, React.createElement("ins", {
        ...
        R("AfterDownloadLightbox", {
            componentDidMount: function() {
                var base, previous_state;
                if (this.props.push_state) {
                    try {
                        ...
                        if (typeof(base = window.history).replaceState === "function") {
                            base.replaceState({}, this.props.push_state.title, this.props.push_state.url)
                        }
                        return this.previous_state = previous_state
                    } catch (error) {}
                }
            },
            componentWillUnmount: function() {
                ...
                if (this.previous_state) {
                    if (typeof(base = window.history).replaceState === "function") {
                        base.replaceState({}, this.previous_state.title, this.previous_state.url)
                    }
                    return delete this.previous_state
                }
            },
            render: function() {
                return R.Lightbox({
                    className: this.enclosing_class_name()
                }, h2({}, this.tt("game.after_download.thanks_for_downloading_title")), p({}, this.tt("game.after_download.thanks_project_author", {
                    author: this.props.user.name,
                    project: em({}, this.props.game.title)
                }), this.props.has_more_games ? fragment({}, " ", this.tt("game.after_download.more_from_creator", {
                    profile: a({
                        href: this.props.user.url
                    }, this.props.user.name)
                })) : void 0, " ", this.tt("game.after_download.check_popup_blocker")), this.props.show_ad ? R.Ads.AfterDownload({}) : void 0, this.props.show_app_banner && this.props.app_url ? p({}, this.tt("game.after_download.app_learn_more", {
                    s: function(args) {
                        return strong({}, args)
                    },
                    a: function(_this) {
                    ...
                    className: "share_row"
                }, this.props.user.follow_button ? R.FollowButton(this.props.user.follow_button) : void 0, this.props.share_buttons ? span({
                    className: "share_links"
                }, span({
                    className: "icon icon-heart"
                }), " ", I.i18n.locale_is_english() ? "Share this " + this.props.game.noun + ":" : this.tt("game.after_download.share_this_project"), R.ShareButtons(this.props.share_buttons)) : void 0), this.render_jam_games() || this.render_rec_games(), div({
            ...
            render_jam_games: function() {
                ...
                }, h3({}, this.tt("game.after_download.check_out_more_from_jam_title", {
                    jam_title: a({
                        href: this.props.related_jam.url,
                        target: "_blank"
                    }, this.props.related_jam.title)
                })), this.render_game_grid(this.props.jam_games, {
                    show_rating: false
                }), this.props.related_jam.entries_url ? div({
                    className: "browse_footer"
                }, a({
                    href: this.props.related_jam.entries_url,
                    className: "button outline"
                }, this.tt("game.after_download.view_all_from_jam"))) : void 0)
            },
            render_rec_games: function() {
                ...
                return section({
                    className: "related_games"
                }, h3({}, this.props.rec_games_title || this.tt("game.after_download.more_from_itchio_header")), this.render_game_grid(this.props.rec_games), div({
                    className: "browse_footer"
                }, a({
                    href: this.props.browse_url,
                    className: "button outline"
                }, this.tt("game.after_download.see_everything"))))
            },
            render_game_grid: function(games, cell_opts) {
                return R.Index.GameGrid({
                    games: games,
                    cell_width: 200,
                    fit_rows: 3,
                    enable_popups: false,
...
(function() {
    I.libs.react.done(function() {
        var P, SEEN_EVENTS, _rdf, a, br, button, code, div, em, fieldset, form, fragment, h1, h2, h3, h4, h5, h6, iframe, img, input, label, legend, li, ol, optgroup, option, p, pre, section, select, span, strong, textarea, types, ul;
        _rdf = ReactDOMFactories;
        div = _rdf.div, span = _rdf.span, a = _rdf.a, br = _rdf.br, p = _rdf.p, ol = _rdf.ol, ul = _rdf.ul, li = _rdf.li, strong = _rdf.strong, em = _rdf.em, img = _rdf.img, form = _rdf.form, label = _rdf.label, input = _rdf.input, textarea = _rdf.textarea, button = _rdf.button, iframe = _rdf.iframe, h1 = _rdf.h1, h2 = _rdf.h2, h3 = _rdf.h3, h4 = _rdf.h4, h5 = _rdf.h5, h6 = _rdf.h6, pre = _rdf.pre, code = _rdf.code, select = _rdf.select, option = _rdf.option, section = _rdf.section, optgroup = _rdf.optgroup, fieldset = _rdf.fieldset, legend = _rdf.legend;
        fragment = React.createElement.bind(null, React.Fragment);
        fragment.type = React.fragment;
        ...
        P("ConversionLink", {
            ...
            propTypes: {
                ...
                target: types.string,
                class: types.any,
                impression: types.bool,
                on_click: types.func,
                on_impression: types.func
            },
            getInitialState: function() {
                return {
                    seen: false
            ...
            get_suffix: function() {
                return this.props.source + ":" + this.props.object_type + ":" + this.props.object_id
            },
            on_click: function(e) {
                var el, finished, is_blank, start;
                if (e.type !== "click") {
                    return
                }
                el = ReactDOM.findDOMNode(this);
                is_blank = e.metaKey || e.ctrlKey || e.shiftKey || this.props.target === "_blank";
                p = this.handle_click();
                if (is_blank) {
                    return
                }
                ...
                finished = function(_this) {
                    return function() {
                        ...
                        finished = null;
                        return window.location = _this.props.href
                    }
                }(this);
                setTimeout(function(_this) {
                    return function() {
            ...
            on_mouse_up: function(e) {
                ...
                return this.handle_click()
            },
            handle_click: function() {
                var base, event_name, ref;
                if (!(this.props.object_type && this.props.source && this.props.object_id)) {
                    return $.when()
                }
                if (this.state.clicked) {
                    return this.state.clicked
                }
                event_name = I.ConversionTracker.types.click + ":" + this.get_suffix();
                if (SEEN_EVENTS[event_name]) {
                    return $.when()
                }
                SEEN_EVENTS[event_name] = true;
                I.ConversionTracker.click(this.get_suffix());
                p = I.ConversionTracker.flush_now_beacon();
                if (this.props.track_referrer) {
                    (ref = I.ReferrerTracker).push.apply(ref, this.props.track_referrer)
                }
                this.setState({
                    clicked: p
                });
                if (typeof(base = this.props).on_click === "function") {
                    base.on_click()
                }
                return p
            },
            componentDidMount: function() {
                ...
                if (this.props.impression === false) {
                    return
                }
                if (SEEN_EVENTS[I.ConversionTracker.types.impression + ":" + this.get_suffix()]) {
                    return
                }
                el = ReactDOM.findDOMNode(this);
                return this.unbind_visibility = $(el).lazy_images({
                    ...
                    show_images: function(_this) {
                        return function() {
                            var base, event_name;
                            event_name = I.ConversionTracker.types.impression + ":" + _this.get_suffix();
                            if (!SEEN_EVENTS[event_name]) {
                                I.ConversionTracker.push(event_name);
                                SEEN_EVENTS[event_name] = true
                            }
                            _this.setState({
                                seen: true
                            });
                            if (typeof(base = _this.props).on_impression === "function") {
                                base.on_impression()
                            }
                            if (typeof _this.unbind_visibility === "function") {
                                _this.unbind_visibility()
                            }
                            return _this.unbind_visibility = null
                        }
                    }(this)
                })
            },
            ...
            render: function() {
                ...
                return a({
                    ...
                    tabIndex: (ref = this.props.tabindex) != null ? ref : this.props.tabIndex,
...
(function() {
    I.libs.react.done(function() {
        var P, PLATFORM_ICONS, PLATFORM_NAMES, _rdf, a, br, button, code, div, em, fieldset, form, fragment, h1, h2, h3, h4, h5, h6, iframe, img, input, label, legend, li, ol, optgroup, option, p, pre, section, select, span, strong, textarea, types, ul, slice = [].slice;
        _rdf = ReactDOMFactories;
        div = _rdf.div, span = _rdf.span, a = _rdf.a, br = _rdf.br, p = _rdf.p, ol = _rdf.ol, ul = _rdf.ul, li = _rdf.li, strong = _rdf.strong, em = _rdf.em, img = _rdf.img, form = _rdf.form, label = _rdf.label, input = _rdf.input, textarea = _rdf.textarea, button = _rdf.button, iframe = _rdf.iframe, h1 = _rdf.h1, h2 = _rdf.h2, h3 = _rdf.h3, h4 = _rdf.h4, h5 = _rdf.h5, h6 = _rdf.h6, pre = _rdf.pre, code = _rdf.code, select = _rdf.select, option = _rdf.option, section = _rdf.section, optgroup = _rdf.optgroup, fieldset = _rdf.fieldset, legend = _rdf.legend;
        fragment = React.createElement.bind(null, React.Fragment);
        fragment.type = React.fragment;
        ...
        P("PlatformList", {
            ...
            render: function() {
                ...
                for (j = 0, len = ref.length; j < len; j++) {
                    ...
                    out.push(span({
                        key: name,
                        className: "icon icon-" + PLATFORM_ICONS[name],
                        "aria-hidden": "true",
                        title: this.props.prefix + " " + PLATFORM_NAMES[name]
                    }))
                }
                return out
            }
        ...
        P("StarRating", {
            ...
            render: function() {
                var average, i;
                average = this.props.average || 0;
                return div({
                    className: "game_rating",
                    title: "Average: " + average.toFixed(2)
                }, span({
                    className: "screenreader_only"
                }, "Average rating " + average.toFixed(2) + " out of 5"), div({
                    className: "star_value"
                }, div({
                    className: "star_fill",
                    style: {
                        width: (average / 5 * 100).toFixed(5) + "%"
                    }
                }, function() {
                    var j, results;
                    results = [];
                ...
                }, "(" + I.format_integer(this.props.count), span({
                    className: "screenreader_only"
                }, " total ratings"), ")"))
            }
        });
        P("GameCell", {
            ...
            getDefaultProps: function() {
                return {
                    ...
                    show_platforms: true,
                    show_rating: true,
                    show_cell_tools: true
                }
            },
            getInitialState: function() {
                return {
                    game: this.build_game()
                }
            },
            componentDidUpdate: function(prev_props) {
                if (prev_props.build_game_object !== this.props.build_game_object || prev_props.game !== this.props.game) {
                    return this.setState({
                        game: this.build_game()
                    })
                }
            },
            update_focus: function(e) {
                return this.setState({
                    cell_tools_focused: e.currentTarget.contains(document.activeElement)
                })
            },
            build_game: function() {
                if (this.props.build_game_object) {
                    return this.props.build_game_object(this.props.game)
                } else {
                    return this.props.game
                }
            },
            add_to_collection: function(e) {
                if (I.current_user) {
                    e.preventDefault();
                    return I.Lightbox.open_remote("/game/collections/" + this.state.game.id, I.CollectionLightbox)
                }
            },
            ...
            track_grid_referrer: function() {
                ...
                return I.ReferrerTracker.push("game", this.state.game.id, this.props.grid_referrer)
            },
            game_link: function() {
                var children, link_props, props;
                props = arguments[0], children = 2 <= arguments.length ? slice.call(arguments, 1) : [];
                if (this.props.conversion_source) {
                    link_props = $.extend({
                        object_type: 1,
                        object_id: this.state.game.id,
                        source: this.props.conversion_source,
                        on_click: this.props.grid_referrer ? this.track_grid_referrer : void 0
                    }, props);
                    return P.ConversionLink.apply(P, [link_props].concat(slice.call(children)))
                }
                return a.apply(null, [props].concat(slice.call(children)))
            },
            render_user: function(user, key) {
                if (key == null) {
                    key = null
                }
                return a({
            ...
            render: function() {
                var b, base, base1, base2, cover_color, g, game, plat, platforms, r, ref, ref1, user;
                game = this.state.game;
                user = game.user;
                platforms = game.platforms ? function() {
                    var j, len, ref, results;
                    ref = game.platforms;
                    results = [];
                    for (j = 0, len = ref.length; j < len; j++) {
                        plat = ref[j];
                        if (PLATFORM_ICONS[plat]) {
                            results.push(plat)
                        }
                    }
                    return results
                }() : void 0;
                cover_color = game.cover_color && I.Color ? (ref = I.Color.parse_color(game.cover_color), r = ref[0], g = ref[1], b = ref[2], ref, "rgba(" + r + ", " + g + ", " + b + ", 0.5)") : void 0;
                return this.enclose({
                    "data-game_id": game.id,
                    dir: "auto",
                    className: classNames("game_cell", {
                        focused: this.state.cell_tools_focused
                    }),
                    onMouseEnter: this.state.game.gif_cover ? function(_this) {
                        return function() {
                            return _this.setState({
                                hovering: true
                            })
                    ...
                    onMouseLeave: this.state.game.gif_cover ? function(_this) {
                        return function() {
                            return _this.setState({
                                hovering: false
                            })
                    ...
                    "aria-hidden": "true",
                    tabIndex: -1
                }, typeof(base = this.props).render_thumb_extras === "function" ? base.render_thumb_extras(game) : void 0, game.cover ? P.LazyImage({
                    src: game.cover
                }) : div({
                    className: "missing_image"
                }, "no image :("), game.gif_cover ? div({
                    className: "gif_label"
                }, "GIF") : void 0, ((ref1 = this.state) != null ? ref1.hovering : void 0) && game.gif_cover ? React.createElement(React.Fragment, {}, !this.state.gif_loaded ? div({
                    className: "gif_loading_overlay"
                }) : void 0, P.LazyImage({
                    className: "gif_cover",
                    src: game.gif_cover,
                    on_load: this.mark_gif_loaded
                })) : void 0), this.props.show_price && game.sale_rate ? div({
                    className: classNames("sale_flag", {
                        reverse_sale: game.sale_rate < 0
                    })
                }, div({
                    className: "rate"
                }, Math.abs(game.sale_rate) + "%"), div({
                    className: "mini_label"
                }, game.sale_rate < 0 ? "more" : "off")) : void 0, (platforms != null ? platforms.length : void 0) ? div({
                    className: "p_data fading_data"
                }, P.PlatformList({
                    platforms: platforms
                })) : void 0, this.props.show_cell_tools ? div({
                    className: "fading_data cell_tools",
                    onFocus: this.update_focus,
                    onBlur: this.update_focus
                }, typeof(base1 = this.props).render_cell_extras === "function" ? base1.render_cell_extras(game) : void 0, a({
                    href: game.url + "/add-to-collection",
                    ...
                    onKeyDown: function(_this) {
                        return function(e) {
                            if (e.key === " ") {
                                return _this.add_to_collection(e)
                            }
                        }
                    }(this)
                }, span({
                    ...
                    if (this.props.show_price) {
                        switch (game.flag) {
                            ...
                            case "demo":
                                return div({
                                    className: "meta_tag demo_tag"
                                }, "Demo");
                            default:
                                if (game.price) {
                                    return div({
                                        className: classNames("price_tag meta_tag")
                                    }, game.price)
                                }
                        }
                    }
                }.call(this), this.game_link({
                    target: this.props.target,
                    className: "title",
                    title: game.title,
                    href: game.url
                    ...
                    className: "user_row"
                }, game.contributors ? game.contributors.map(function(_this) {
                    return function(user, idx) {
                        if (idx > 0) {
                            return fragment({
                                key: "user-" + idx
                            }, ", ", _this.render_user(user))
                        } else {
                            return _this.render_user(user, "user-" + idx)
                        }
                    }
                }(this)) : this.render_user(user)), this.props.show_rating && game.rating ? P.StarRating(game.rating) : void 0, game.tags && game.tags.length ? div({
                    className: "sub cell_tags"
                }, game.tags.map(function(_this) {
                    return function(tag, idx) {
                ...
                }(this))) : void 0, this.props.show_short_text ? game.short_text ? div({
                    className: "sub short_text"
                }, game.short_text) : void 0 : void 0, typeof(base2 = this.props).render_cell_below === "function" ? base2.render_cell_below(game) : void 0)
            }
        });
        P("GameGrid", {
            calculate_cell_sizes: function(_this) {
                return function() {
                    var ref, ref1;
                    return (ref = _this.grid_sizer_ref) != null ? (ref1 = ref.current) != null ? ref1.calculate_cell_sizes() : void 0 : void 0
                }
            }(this),
            componentDidMount: function() {
                var container;
                container = this.container();
                if (this.props.enable_popups) {
                    return new I.GamePopups(container, {
                        x_offset: 10
                    })
                }
            },
            getDefaultProps: function() {
                return {
                    ...
                    render_game: function(game) {
                        ...
                        if (this.props.cell_props) {
                            cell_props = $.extend(cell_props, this.props.cell_props)
                        }
                        return P.GameCell(cell_props)
                    }
                }
            },
            render: function() {
                var props, ref;
                props = {
                    ref: this.grid_sizer_ref || (this.grid_sizer_ref = React.createRef()),
                    cell_margin: 10,
                    expected_width: this.props.cell_width,
                    fit_rows: this.props.fit_rows,
                    children: (ref = this.props.games) != null ? ref.map(this.props.render_game.bind(this)) : void 0
                };
                if (this.props.grid_sizer_props) {
                    props = $.extend(props, this.props.grid_sizer_props)
                }
                return this.enclose({}, P.GridSizer(props))
            }
        });
        P("NewFromFollowers", {
            getInitialState: function() {
            ...
            componentDidUpdate: function(prev_props, prev_state) {
                var ref, ref1;
                if (((ref = prev_state.games) != null ? ref.length : void 0) !== ((ref1 = this.state.games) != null ? ref1.length : void 0)) {
                    return $(window).trigger("i:reshape")
                }
            },
            on_dismiss_games: function(e) {
                var g, grid_sizer, ref, ref1, ref2, ref3, visible_games;
                if ((ref = this.state) != null ? ref.loading : void 0) {
                    return
                }
                grid_sizer = (ref1 = this.game_grid_ref) != null ? (ref2 = ref1.current) != null ? (ref3 = ref2.grid_sizer_ref) != null ? ref3.current : void 0 : void 0 : void 0;
                if (!grid_sizer) {
                    return
                }
                visible_games = this.state.games.slice(0, grid_sizer.get_num_visible());
                if (!visible_games.length) {
                    return
                }
                this.setState({
                    loading: true
                });
                return $.post(this.props.dismiss_url, I.with_csrf({
                    object_type: "game",
                    object_id: function() {
                        var j, len, results;
                        results = [];
                        for (j = 0, len = visible_games.length; j < len; j++) {
                            g = visible_games[j];
                            results.push(g.id)
                        }
                        return results
                    ...
                    return function(res) {
                        return $.get(_this.props.more_results_url).done(function(more_games) {
                            return _this.setState({
                                games: _.toArray(more_games.games),
                                loading: false
                            })
                        })
                    }
            ...
            render_cell_extras: function(game) {
                return button({
                    type: "button",
                    className: "dismiss_btn",
                    onClick: function(_this) {
                        return function() {
                            var g, remaining_games;
                            remaining_games = function() {
                                var j, len, ref, results;
                                ref = this.state.games;
                                results = [];
                                for (j = 0, len = ref.length; j < len; j++) {
                                    g = ref[j];
                                    if (g !== game) {
                            ...
                            return $.post(_this.props.dismiss_url, I.with_csrf({
                                object_type: "game",
                                object_id: game.id
                            })).done(function(res) {
                                return _this.fetch_more_if_necessary()
                            })
                        }
                    }(this)
                }, "Dismiss")
            ...
            fetch_more_if_necessary: function() {
                ...
                grid = (ref = this.game_grid_ref) != null ? (ref1 = ref.current) != null ? (ref2 = ref1.grid_sizer_ref) != null ? ref2.current : void 0 : void 0 : void 0;
                if (!grid) {
                    return
                }
                if (!(grid.get_max_num_visible() > grid.get_num_visible())) {
                    return
                }
                this.setState({
                    loading: true
                });
                return $.get(this.props.more_results_url).done(function(_this) {
                    return function(more_games) {
                        more_games = _.toArray(more_games != null ? more_games.games : void 0);
                        return _this.setState({
                            exhausted: more_games.length < grid.get_max_num_visible(),
                            games: more_games,
                            loading: false
                        })
                    }
            ...
            render: function() {
                ...
                return this.enclose({
                    component: "section",
                    className: classNames("game_section", {
                        loading: (ref = this.state) != null ? ref.loading : void 0
                    })
                }, div({
                    className: "header_split"
                }, div({}, div({
                    className: "section_header"
                }, h2({}, "New From Those You Follow")), p({
                    className: "section_description"
                }, "Projects from those you follow that you haven't seen yet.")), this.render_dismiss_button()), P.GameGrid({
                    ref: this.game_grid_ref || (this.game_grid_ref = React.createRef()),
                    games: this.state.games,
                    fit_rows: this.props.fit_rows,
                    conversion_source: this.props.conversion_source,
                    grid_referrer: this.props.grid_referrer,
    ...
    I.libs.react.done(function() {
        ...
        P("GridSizer", {
            ...
            componentDidMount: function() {
                _.defer(function(_this) {
                    return function() {
                        return _this.calculate_cell_sizes()
                    }
                }(this));
                this.resize_callback = _.debounce(function(_this) {
                    return function() {
                        return _this.calculate_cell_sizes()
                    }
                }(this), 250);
                return $(window).on("resize", this.resize_callback)
            },
            componentWillUnmount: function() {
                this.unmounted = true;
                return $(window).off("resize", this.resize_callback)
            },
            componentDidUpdate: function(prev_props) {
                if (prev_props.children !== this.props.children) {
                    return _.defer(function(_this) {
                        return function() {
                            return _this.calculate_cell_sizes()
                        }
            ...
            calculate_cell_sizes: function(recurse) {
                var calculated_width, container_width, new_width, num_cells, real_num_cells, real_width;
                if (recurse == null) {
                    recurse = false
                }
                if (this.unmounted) {
                ...
                container_width = this.get_width();
                if (this.state.container_width === container_width) {
                    return
                }
                real_width = this.props.expected_width + this.props.cell_margin;
                calculated_width = container_width + this.props.cell_margin;
                num_cells = calculated_width / real_width;
                real_num_cells = Math.ceil(num_cells);
                if (real_num_cells < this.props.min_columns) {
                    real_num_cells = this.props.min_columns
                }
                new_width = calculated_width / real_num_cells - this.props.cell_margin;
                new_width = Math.floor(new_width);
                if (new_width < this.props.min_width && real_num_cells > 1) {
                    real_num_cells -= 1;
                    new_width = calculated_width / real_num_cells - this.props.cell_margin;
                    new_width = Math.floor(new_width)
                }
                this.setState({
                    ...
                    cells_per_row: real_num_cells
                }, this.props.on_reshape);
                if (recurse === false) {
                    return _.defer(function(_this) {
                        return function() {
                            return _this.calculate_cell_sizes(true)
                        }
                    }(this))
                }
            },
            get_width: function() {
                var el, fraction_el, out, r, ref;
                el = this.container();
                fraction_el = (ref = el[0]) != null ? ref.getBoundingClientRect().width : void 0;
                r = fraction_el - Math.floor(fraction_el);
                out = Math.floor(el.width());
                if (r > 0) {
                    out -= 1
                }
                return out
            ...
            get_num_visible: function() {
                var num_children;
                num_children = this.props.children.length;
                if (this.props.fit_rows && this.state.cells_per_row) {
                    return Math.min(num_children, this.state.cells_per_row * this.props.fit_rows)
                } else {
                    return num_children
                }
            },
            get_visible_children: function() {
                ...
                if (this.props.fit_rows && this.state.cells_per_row) {
                    children = children.slice(0, this.state.cells_per_row * this.props.fit_rows)
                }
                return children
            },
            render: function() {
                var children, container_style, estimated_min, ratio, sizer_style, template_columns;
                children = this.get_visible_children();
                sizer_style = {
                    display: "grid",
                    alignItems: "start",
                    gap: this.props.cell_margin + "px"
                };
                container_style = this.props.crop_on_resize ? {
                    overflowX: "hidden"
                } : void 0;
                if (this.props.crop_on_resize && this.state.container_width) {
                    sizer_style.width = this.state.container_width + "px"
                }
                template_columns = this.state.cell_width && this.state.cells_per_row ? sizer_style.gridTemplateColumns = "repeat(" + this.state.cells_per_row + ", " + this.state.cell_width + "px)" : (ratio = window.innerWidth < 400 ? 5 / 9 : 7 / 9, estimated_min = Math.floor(this.props.expected_width * ratio), sizer_style.gridTemplateColumns = "repeat(auto-fill, minmax(" + estimated_min + "px, 1fr))");
                return this.enclose({
                    component: this.props.component,
                    style: container_style
                }, React.createElement(this.props.sizer_component || "div", {
                    className: "grid_sizer_children",
                    style: sizer_style
                }, children))
            }
        })

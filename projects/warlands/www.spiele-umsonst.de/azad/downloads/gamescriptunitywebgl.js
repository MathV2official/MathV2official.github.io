...
window.onresize = function () {
  ...
  try {
    document.getElementById("unityContainer").style.height = newHeight + "px";
  } catch {}
  try {
    document.getElementById("unityContainer").style.width = newWidth + "px";
  } catch {}
  try {
    document.getElementById("gameContainer").style.height = newHeight + "px";
  } catch {}
  try {
    document.getElementById("gameContainer").style.width = newWidth + "px";
  } catch {}
};
function reportSize() {

...
(function (TWP2) {
  ...
  var WeaponDatabase = /** @class */ (function () {
      ...
      WeaponDatabase.GetUnlocksForKills = function (_weaponId, _kills) {
          var arr = [];
          var check = [
              WeaponDatabase.GetAllModsFor(WeaponDatabase.MOD_MAG, _weaponId),
              WeaponDatabase.GetAllModsFor(WeaponDatabase.MOD_BARREL, _weaponId),
              WeaponDatabase.GetAllModsFor(WeaponDatabase.MOD_MUZZLE, _weaponId)
          ];
      ...
      WeaponDatabase.GetUnlocksForHeadshots = function (_weaponId, _headshots) {
          var arr = [];
          var check = [
              WeaponDatabase.GetAllModsFor(WeaponDatabase.MOD_BASE, _weaponId),
              WeaponDatabase.GetAllModsFor(WeaponDatabase.MOD_OPTIC, _weaponId)
          ];
          for (var i = 0; i < check.length; i++) {
              var cur = check[i];
              for (var j = 0; j < cur.length; j++) {
      ...
      WeaponDatabase.IsDefaultMod = function (_id) {
          ...
          if (_id.indexOf(WeaponDatabase.BASE_DEFAULT) >= 0 ||
      ...
      WeaponDatabase.GetAvailableModsFor = function (_id) {
          ...
          if (weapon["type"] == WeaponDatabase.TYPE_PISTOL || weapon["type"] == WeaponDatabase.TYPE_MACHINE_PISTOL) {
              if (_id == WeaponDatabase.WEAPON_MAXIM9) {
                  return [
                      WeaponDatabase.MOD_BASE,
                      WeaponDatabase.MOD_MAG
                  ];
              }
              return [
                  WeaponDatabase.MOD_BASE,
                  WeaponDatabase.MOD_MAG,
                  WeaponDatabase.MOD_BARREL,
                  WeaponDatabase.MOD_MUZZLE
              ];
          }
          else if (weapon["type"] == WeaponDatabase.TYPE_LAUNCHER) {
              return [
...
(function (TWP2) {
  var Engine = /** @class */ (function (_super) {
      ...
      Engine.prototype.loadMenuState = function (_menuId) {
          if (_menuId === void 0) { _menuId = null; }
  ...
  var MiddleInfo = /** @class */ (function (_super) {
      ...
      function MiddleInfo() {
          ...
          if (TWP2.GameUtil.GetGameState().getGameMode().getId() == TWP2.GameModeDatabase.GAME_RANGE) {
              ...
              container.add(key);
              gfx.destroy();
              var keyText = _this.game.add.text(0, 2, TWP2.GameUtil.GetKeyStringFromId(TWP2.PlayerUtil.GetControlsData()[TWP2.PlayerUtil.CONTROL_ACTION]), { font: "16px " + TWP2.FontUtil.FONT, fill: "#FFFFFF", boundsAlignH: "center", boundsAlignV: "middle" });
          ...
          else if (TWP2.GameUtil.GetGameState().getGameMode().getId() == TWP2.GameModeDatabase.GAME_DEFENDER ||
              TWP2.GameUtil.GetGameState().getGameMode().getId() == TWP2.GameModeDatabase.GAME_WAR) {
          ...
          if (this.state == GameMode.STATE_WAITING_PRE_MATCH) {
              if (this.preTimer > 0) {
                  if (this.preTimer % 60 == 0) {
                      ...
                      if (seconds <= 3) {
                          TWP2.GameUtil.GetGameState().getHUD().addCountdownText((this.preTimer / 60).toString());
                      }
                  }
                  this.preTimer--;
              }
  ...
  var GameMode_MultiShooter = /** @class */ (function (_super) {
      ...
      GameMode_MultiShooter.prototype.createTarget = function () {
          if (TWP2.GameUtil.GetGameState().getNumLivingTargets() < TWP2.GameUtil.GetGameState().getMaxPawns()) {
              ...
              var target = TWP2.GameUtil.GetGameState().createTarget(TWP2.MathUtil.Random(TWP2.GameUtil.game.world.width * 0.2, TWP2.GameUtil.game.world.width * 0.8), TWP2.MathUtil.Random(200, TWP2.GameUtil.game.world.height - 150), targetType, material);
  ...
  var GameMode_Hardened = /** @class */ (function (_super) {
      ...
      GameMode_Hardened.prototype.createTarget = function () {
          if (TWP2.GameUtil.GetGameState().getNumLivingTargets() < TWP2.GameUtil.GetGameState().getMaxPawns()) {
              ...
              var target = TWP2.GameUtil.GetGameState().createTarget(TWP2.MathUtil.Random(TWP2.GameUtil.game.world.width * 0.2, TWP2.GameUtil.game.world.width * 0.8), TWP2.MathUtil.Random(200, TWP2.GameUtil.game.world.height - 150), targetType, TWP2.Target.MATERIAL_METAL);
  ...
  var GameMode_Sniper = /** @class */ (function (_super) {
      ...
      GameMode_Sniper.prototype.createTarget = function () {
          if (TWP2.GameUtil.GetGameState().getNumLivingTargets() < TWP2.GameUtil.GetGameState().getMaxPawns()) {
              ...
              var material = TWP2.MathUtil.Random(1, 10) == 1 ? TWP2.Target.MATERIAL_METAL : TWP2.Target.MATERIAL_DEFAULT;
              var target = TWP2.GameUtil.GetGameState().createTarget(TWP2.MathUtil.Random(TWP2.GameUtil.game.world.width * 0.6, TWP2.GameUtil.game.world.width * 0.92), TWP2.MathUtil.Random(200, TWP2.GameUtil.game.world.height - 150), targetType, material);
              this.targetsSpawned++;
          }
      };
  ...
  var State_Game = /** @class */ (function (_super) {
      ...
      */
      ...
      State_Game.prototype.shakeCamera = function (_val, _bScale) {
          if (_bScale === void 0) { _bScale = true; }
      ...
      State_Game.prototype.createTarget = function (_x, _y, _type, _material) {
          if (_type === void 0) { _type = TWP2.Target.TYPE_DEFAULT; }
          if (_material === void 0) { _material = TWP2.Target.MATERIAL_DEFAULT; }
      ...
      State_Game.prototype.createMuzzleFlash = function (_x, _y, _rotation, _type, _scale, _bForceFlash) {
          ...
          if (_bForceFlash === void 0) { _bForceFlash = false; }
          var smoke;
          if (_type == "default") {
...
(function (TWP2) {
  var State_Menu = /** @class */ (function (_super) {
      ...
      State_Menu.prototype.loadMainMenu = function (_menuId) {
          if (_menuId === void 0) { _menuId = TWP2.MainMenu.MENU_MAIN; }
...
(function (TWP2) {
  ...
  var SplashButton = /** @class */ (function (_super) {
      ...
      function SplashButton(_colour) {
          if (_colour === void 0) { _colour = TWP2.ColourUtil.COLOUR_BUTTONS; }
          var _this = this;
          var gfx = TWP2.GameUtil.game.add.graphics();
          gfx.beginFill(0xFFFFFF, 0);
      ...
      SplashButton.prototype.setIcon = function (_atlas, _id, _colour) {
          if (_colour === void 0) { _colour = 0xFFFFFF; }
  ...
  var MenuButton = /** @class */ (function (_super) {
      ...
      function MenuButton(_width, _boundsAlignH, _colour, _height, _fontSize) {
          ...
          if (_boundsAlignH === void 0) { _boundsAlignH = "center"; }
          if (_colour === void 0) { _colour = TWP2.ColourUtil.COLOUR_BUTTONS; }
          if (_height === void 0) { _height = 40; }
          if (_fontSize === void 0) { _fontSize = 14; }
          var _this = this;
          var gfx = TWP2.GameUtil.game.add.graphics();
          gfx.beginFill(0xFFFFFF, 0);
      ...
      MenuButton.prototype.setLabelText = function (_val, _bSetDefaultLabelStyle) {
          if (_bSetDefaultLabelStyle === void 0) { _bSetDefaultLabelStyle = false; }
...
(function (TWP2) {
  ...
  var GameStat = /** @class */ (function (_super) {
      ...
      function GameStat(_title, _val, _size, _colour) {
          ...
          if (_colour === void 0) { _colour = TWP2.ColourUtil.COLOUR_XP_STRING; }
          var _this = _super.call(this, TWP2.GameUtil.game) || this;
          var gfx = _this.game.add.graphics();
          gfx.beginFill(0xFFFFFF, 0);
  ...
  var KeyIcon = /** @class */ (function (_super) {
      ...
      function KeyIcon(_size, _style) {
          ...
          if (_style === void 0) { _style = KeyDetail.STYLE_DEFAULT; }
          var _this = _super.call(this, TWP2.GameUtil.game) || this;
          var gfx = _this.game.add.graphics();
  ...
  var StarContainer = /** @class */ (function (_super) {
      ...
      function StarContainer(_iconId) {
          if (_iconId === void 0) { _iconId = "icon_star"; }
          var _this = _super.call(this, TWP2.GameUtil.game) || this;
  ...
  var GameOverMenu = /** @class */ (function (_super) {
      ...
      GameOverMenu.prototype.onTweenComplete = function (_param1, _param2, _id) {
          if (_id == "tween_init") {
              ...
              var bestText = this.game.add.text(0, 0, this.bNewBestScore ? "New personal best!" : "Your personal best: " + lastBestScore, { font: "14px " + TWP2.FontUtil.FONT, fill: this.bNewBestScore ? TWP2.ColourUtil.COLOUR_GREEN_STRING : "#CCCCCC" });
  ...
  var PauseMenu = /** @class */ (function (_super) {
      ...
      PauseMenu.prototype.loadMenu = function (_id) {
          ...
          if (_id == PauseMenu.MENU_DEFAULT) {
              ...
              gameTextContainer.x = //modeIcon.x + modeIcon.width;
                  gameTextContainer.y = (modeIcon.y + (modeIcon.height * 0.5)) - (gameTextContainer.height * 0.5) + 5;
...
(function (TWP2) {
  var PlayMenu = /** @class */ (function (_super) {
      ...
      PlayMenu.prototype.setMenu = function (_id) {
          ...
          if (_id == PlayMenu.MENU_GAMES) {
              ...
              */
              ...
              var favKillsText = this.game.add.text(0, 0, favWeaponId ? (TWP2.GameUtil.FormatNum(TWP2.PlayerUtil.player.weapons[favWeaponId]["kills"]) + " kills â€¢ " + TWP2.GameUtil.FormatNum(TWP2.PlayerUtil.player.weapons[favWeaponId]["headshots"]) + " headshots") : "No weapons used yet", { font: "14px " + TWP2.FontUtil.FONT, fill: "#FFFFFF", boundsAlignH: "center" });
      ...
      PlayMenu.prototype.selectLoadout = function (_num, _weaponIndex) {
          if (_weaponIndex === void 0) { _weaponIndex = 0; }
  ...
  var WeaponStat = /** @class */ (function (_super) {
      ...
      function WeaponStat(_labelText, _barWidth) {
          if (_barWidth === void 0) { _barWidth = 470; }
          var _this = _super.call(this, TWP2.GameUtil.game) || this;
          _this.value = 0;
      ...
      Window.prototype.setFromData = function (_data) {
          ...
          if (_data) {
              ...
              if (type == Window.TYPE_YES_NO) {
                  ...
                  var playDesc = this.game.add.text(0, 0, "Select a game mode and play the objective. You will be awarded a star rank based on your score. Try to earn all " + TWP2.GameModeDatabase.RANKED_STARS + " stars for every game mode!", { font: "14px " + TWP2.FontUtil.FONT, fill: "#FFFFFF", align: "center", wordWrap: true, wordWrapWidth: wrapWidth });
                  ...
                  var loadoutsDesc = this.game.add.text(0, 0, "Customize your weapon loadouts by modifying your primary and secondary weapon. New weapons and attachments are unlocked as you rank up.", { font: "14px " + TWP2.FontUtil.FONT, fill: "#FFFFFF", align: "center", wordWrap: true, wordWrapWidth: wrapWidth });
                  ...
                  var skillsDesc = this.game.add.text(0, 0, "Improve your performance by upgrading your skills! Skill points are awarded as you rank up.", { font: "14px " + TWP2.FontUtil.FONT, fill: "#FFFFFF", align: "center", wordWrap: true, wordWrapWidth: wrapWidth });
                  ...
                  var controls = [
                      TWP2.PlayerUtil.CONTROL_RELOAD,
                      TWP2.PlayerUtil.CONTROL_SWITCH_WEAPON,
                      TWP2.PlayerUtil.CONTROL_BARREL,
                      TWP2.PlayerUtil.CONTROL_ACTION
                  ];
                  ...
                  yesButton.setCallback(this.buyAndCallback, this, [
                      _data["cost"],
                      _data["buyCallback"],
                      _data["buyCallbackContext"],
                      _data["buyCallbackParams"]
                  ]);
                  buttons.add(yesButton);
                  if (bCanAfford && _data["bShowEquipButton"] == true) {
                      ...
                      equipButton.setCallback(this.buyAndCallback, this, [
                          _data["cost"],
                          _data["buyCallback"],
                          _data["buyCallbackContext"],
                          _data["equipCallbackParams"]
                      ]);

! function(e) {
    ...
    class te {
        ...
        static onSubscriptionChanged_showWelcomeNotification(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (OneSignal.__doNotShowWelcomeNotification) E.a.debug("Not showing welcome notification because user has previously subscribed.");
                else if (!0 === e) {
                    const {
                        deviceId: e
                    } = yield M.a.getSubscription(), {
                        appId: t
                    } = yield M.a.getAppConfig(), i = OneSignal.config.userConfig.welcomeNotification, n = void 0 !== i && !0 === i.disable;
                    ...
                    o = x.a.decodeHtmlEntities(o), s = x.a.decodeHtmlEntities(s), n || (E.a.debug("Sending welcome notification."), C.sendNotification(t, [e], {
                        en: o
                    }, {
                        en: s
                    }, a, null, {
    ...
    class ae {
        ...
        isSafari() {
            return g.a.safari && void 0 !== window.safari && void 0 !== window.safari.pushNotification
        }
        getDeliveryPlatform() {
            const e = N.a.redetectBrowserUserAgent();
            return this.isSafari() ? ne.Safari : e.firefox ? ne.Firefox : e.msedge ? ne.Edge : ne.ChromeLike
        }
        serialize() {
            const e = {
    ...
    class ce extends ae {
        ...
        serialize() {
            ...
            return this.subscription && (e.identifier = g.a.safari ? this.subscription.safariDeviceToken : this.subscription.w3cEndpoint ? this.subscription.w3cEndpoint.toString() : null, e.web_auth = this.subscription.w3cAuth, e.web_p256 = this.subscription.w3cP256dh), e
        }
    ...
    class Vt {
        ...
        static upsertSession(e, t, i, n, o, s) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!r) {
                    ...
                    return s && (t.notificationId = s.notificationId), yield M.a.upsertSession(t), void(yield Vt.sendOnSessionCallIfNecessary(o, i, n, t))
                }
                ...
                if (Vt.timeInSecondsBetweenTimestamps(a, r.lastDeactivatedTimestamp) <= e) return r.status = me.c.Active, r.lastActivatedTimestamp = a, r.lastDeactivatedTimestamp = null, void(yield M.a.upsertSession(r));
                ...
                yield M.a.upsertSession(c), yield Vt.sendOnSessionCallIfNecessary(o, i, n, c)
            })
        }
        static deactivateSession(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (n.status === me.c.Inactive) return bt(() => Vt.finalizeSession(n, t, i), e);
    ...
    class Lt {
        ...
        haveParamsChanged() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const n = Ee.getAvailableServiceWorker(e),
                    o = Vt.getServiceWorkerHref(this.config, this.context.appConfig.appId, h.a.version());
        ...
        installWorker() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const e = Vt.getServiceWorkerHref(this.config, this.context.appConfig.appId, h.a.version()),
    ...
    class Ht {
        ...
        subscribeSafari() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (ue.a.triggerNotificationPermissionChanged(), !i) throw new Ft(_t.InvalidSafariSetup);
        ...
        subscribeFcmFromPage(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (y.a.getWindowEnv() !== oe.a.ServiceWorker && Notification.permission === A.Default) {
                    ...
                    switch (e === A.Default && (yield ue.a.triggerNotificationPermissionChanged(!0)), e) {
                        case A.Default:
    ...
    var $t = class {
        static getServiceWorkerManager(e) {
            ...
            return t.userConfig && (t.userConfig.path && (n.workerPath = new st(`${t.userConfig.path}${t.userConfig.serviceWorkerPath}`)), t.userConfig.serviceWorkerParam && (n.registrationOptions = t.userConfig.serviceWorkerParam)), new Lt(e, n)
        }
    ...
    class ri {
        ...
        addSmsInputEventListeners() {
            ...
            e.addEventListener("keyup", t => {
                var i, n;
                this.smsInputFieldIsValid = this.itiOneSignal.isValidNumber() || "" === (null === (i = e) || void 0 === i ? void 0 : i.value), "Enter" === t.key && (null === (n = document.getElementById(L.allowButton)) || void 0 === n || n.click()), this.updateValidationOnSmsInputChange()
        ...
        addEmailInputEventListeners() {
            ...
            e.addEventListener("keyup", t => {
                ...
                this.emailInputFieldIsValid = ri.validateEmailInputWithReturnVal(o), "Enter" === t.key && (null === (n = document.getElementById(L.allowButton)) || void 0 === n || n.click()), this.updateValidationOnEmailInputChange()
            })
        }
        ...
        mount() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                Object(X.l)(`#${L.body}`).appendChild(i), e && (this.initializePhoneInputLibrary(), this.addSmsInputEventListeners()), t && this.addEmailInputEventListeners()
            })
        }
    ...
    class ai extends p.a {
        constructor(e) {
            ...
            super(t), this.description = Xt[e], this.reason = e, Object.setPrototypeOf(this, ai.prototype)
        }
    }
    class ci {
        constructor(e) {
        ...
        create(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (null === this.notificationIcons) {
                    ...
                    this.notificationIcons = t, this.container.className.includes(W.container) && Object(X.w)(`#${L.container}`);
                    const i = e && this.tagCategories ? this.positiveUpdateButton : this.options.text.acceptButton,
                        ...
                        s = document.createElement("div"),
                        r = document.createElement("div");
                    s.id = L.container, Object(X.a)(s, W.container), Object(X.a)(s, W.reset), Object(X.l)("body").appendChild(s), r.id = L.dialog, Object(X.a)(r, W.dialog), r.appendChild(o), this.container.appendChild(r), Object(X.a)(this.container, g.a.mobile ? W.slideUp : W.slideDown), this.allowButton.addEventListener("click", this.onSlidedownAllowed.bind(this)), this.cancelButton.addEventListener("click", this.onSlidedownCanceled.bind(this))
                }
            })
        }
        ...
        onSlidedownCanceled(e) {
            ci.triggerSlidedownEvent(ci.EVENTS.CANCEL_CLICK), this.close(), ci.triggerSlidedownEvent(ci.EVENTS.CLOSED)
        }
        close() {
            Object(X.a)(this.container, W.closeSlidedown), Object(X.u)(this.dialog, "animationend", (e, t) => {
                e.target !== this.dialog || "slideDownExit" !== e.animationName && "slideUpExit" !== e.animationName || (Object(X.w)(`#${L.container}`), t())
            }, !0)
        }
        setSaveState() {
        ...
        removeFailureState() {
            Object(X.w)("#onesignal-button-indicator-holder"), Object(X.v)(this.allowButton, "onesignal-error-state-button"), k.isSlidedownPushDependent(this.options.type) || ri.resetInputErrorStates(this.options.type), this.isShowingFailureState = !1
        }
        ...
        getIndicatorHolder() {
            const e = document.createElement("div");
            return e.id = L.buttonIndicatorHolder, Object(X.a)(e, W.buttonIndicatorHolder), e
        }
        getTextSpan(e) {
    ...
    class gi {
        ...
        installEventHooksForSlidedown() {
            this.eventHooksInstalled = !0, OneSignal.emitter.on(ci.EVENTS.SHOWN, () => {
            ...
            }), OneSignal.emitter.on(ci.EVENTS.ALLOW_CLICK, () => Object(d.a)(this, void 0, void 0, function*() {
    ...
    class bi {
        mount(e, t) {
            ...
            Object(X.l)(`#${L.body}`).appendChild(i), this.taggingContainer && this.taggingContainer.addEventListener("change", this.toggleCheckedTag);
            const n = Object(X.l)(`#${L.allowButton}`);
            n.disabled = !1, Object(X.v)(n, "disabled"), Object(X.w)(`#${L.loadingContainer}`)
        }
        load() {
        ...
        static getValuesFromTaggingContainer() {
            const e = `#${L.body} > div.${H.taggingContainer}` + "> div > div > label > input[type=checkbox]",
                t = {};
    ...
    class yi {
        ...
        handleAllowClick() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                switch (e && (e.close(), k.isSlidedownPushDependent(t) || (yield this.showConfirmationToast()), yield ui(1e3), ci.triggerSlidedownEvent(ci.EVENTS.CLOSED)), t) {
                    case T.Push:
                    case T.Category:
                        E.a.debug("Setting flag to not show the slidedown to the user again."), Fe.markPromptDismissedWithType(Te.Push);
                        break;
        ...
        createSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (function() {
                    ...
                    OneSignal.slidedown = new ci(t), yield OneSignal.slidedown.create(e.isInUpdateMode), yield this.mountAuxiliaryContainers(e), E.a.debug("Showing OneSignal Slidedown"), ci.triggerSlidedownEvent(ci.EVENTS.SHOWN)
                } catch (e) {
    ...
    }(si = oi || (oi = {}))[si.Dashboard = 0] = "Dashboard", si[si.JavaScript = 1] = "JavaScript";
    const Ii = 10;
    class Pi {
        ...
        static getIntegrationCapabilities(e) {
            switch (e) {
                ...
                case ti.WordPress:
                    return {
                        configuration: oi.JavaScript
                    };
                default:
                    return {
                        configuration: oi.Dashboard
                    }
            }
        }

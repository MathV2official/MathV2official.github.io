    ...
    */
    ...
    var C = /:[0-9]+$/,
        F = function(a, b) {
            ...
            "port" === b ? a.port = String(Number(a.hostname ? a.port : w.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || w.location.hostname).replace(C, "").toLowerCase());
            return E(a, b)
        },
        E = function(a, b, c) {
            var d = D(a.protocol);
